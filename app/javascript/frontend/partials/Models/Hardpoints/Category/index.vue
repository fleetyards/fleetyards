  ...
  data() {
    return {
      ...
      icons: {
        ...
        shield_generators: require('images/hardpoints/shield_generators.svg').default,
        ...
        quantum_fuel_tanks: require('images/hardpoints/quantum_fuel_tanks.svg').default,
        main_thrusters: require('images/hardpoints/main_thrusters.svg').default,
        maneuvering_thrusters: require('images/hardpoints/maneuvering_thrusters.svg').default,
