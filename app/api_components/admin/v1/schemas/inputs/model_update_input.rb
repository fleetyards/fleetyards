        ...
        class ModelUpdateInput
          ...
          schema({
            ...
            properties: {
              ...
              landedHolo: {type: [:string, :null]},
              landedTopView: {type: [:string, :null]},
              landedSideView: {type: [:string, :null]},
              landedFrontView: {type: [:string, :null]},
              landedAngledView: {type: [:string, :null]},
              landedTopViewColored: {type: [:string, :null]},
              landedSideViewColored: {type: [:string, :null]},
              landedFrontViewColored: {type: [:string, :null]},
              landedAngledViewColored: {type: [:string, :null]},
