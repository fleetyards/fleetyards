export default {
  ...
  commodityPrice: {
    info: 'Please report missing Stations, Shops and Commodity Items via Email to <a href="mailto:info@fleetyards.net">info@fleetyards.net</a>',
  },
  twoFactor: {
    backupCodes:
  ...
  syncExtension: {
    gettingStarted:
      "To sync your RSI Hangar with Fleetyards you first need to install the Fleetyards Sync Extension for Firefox or Chromium based Browsers.",
