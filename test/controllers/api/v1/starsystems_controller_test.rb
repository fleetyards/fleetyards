    ...
    class StarsystemsControllerTest < ActionController::TestCase
      ...
      let(:index_result) do
        [{
          ...
          'storeImageThumb' => oberon.store_image.small.url,
          'mapX' => nil,
          'mapY' => nil,
          'description' => nil,
          'type' => nil,
          ...
          'storeImageThumb' => stanton.store_image.small.url,
          'description' => nil,
          'mapX' => nil,
          'mapY' => nil,
          'type' => nil,
          ...
          'celestialObjects' => [{
            ...
            'storeImageThumb' => stanton.celestial_objects.first.store_image.small.url,
            'description' => nil,
            'habitable' => nil,
            'fairchanceact' => nil,
            'subType' => nil,
            ...
            'storeImageThumb' => stanton.celestial_objects.last.store_image.small.url,
            'description' => nil,
            'habitable' => nil,
            'fairchanceact' => nil,
            'subType' => nil,
