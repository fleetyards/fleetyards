...
json.component do
  json.partial! "api/v2/models/component", component: hardpoint.component if hardpoint.component.present?
end
json.component nil if hardpoint.component.blank?

json.loadouts do
  json.array! hardpoint.model_hardpoint_loadouts, partial: "api/v2/models/hardpoint_loadout", as: :loadout
end
