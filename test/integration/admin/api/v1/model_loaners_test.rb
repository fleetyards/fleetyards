...
class Admin::Api::V1::ModelLoanersTest < ActionDispatch::IntegrationTest
  ...
  api_path "/model-loaners" do
    post("Create Model Loaner") do
      ...
      request_body required: true, schema: ::Admin::V1::Schemas::Inputs::ModelLoanerInput

      response(201, "successful") do
        schema ::Admin::V1::Schemas::Models::Loaners::ModelLoaner
      end
    ...
    get("Model Loaners list") do
      ...
      parameter name: "q", in: :query,
        schema: ::Admin::V1::Schemas::Queries::ModelLoanerQuery,
        style: :deepObject,
        explode: true,
        required: false

      response(200, "successful") do
        schema ::Admin::V1::Schemas::Models::Loaners::ModelLoaners
      end
