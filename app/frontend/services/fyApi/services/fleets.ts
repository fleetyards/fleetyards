...
export const getFleetQueryOptions = <
...
>(
  ...
  return {
    ...
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof fleet>>, TError, TData>;
};
...
>(
  ...
  const queryOptions = getFleetQueryOptions(slug, options);
...
export const getFleetInvitesQueryOptions = <
...
>(options?: {
  ...
  const queryOptions = getFleetInvitesQueryOptions(options);
...
export const getMyFleetsQueryOptions = <
...
>(options?: {
  ...
  const queryOptions = getMyFleetsQueryOptions(options);
...
export const getFleetVehiclesExportQueryOptions = <
...
>(
  ...
  const queryOptions = getFleetVehiclesExportQueryOptions(
    fleetSlug,
    params,
    options,
  );
...
export const getFleetVehiclesQueryOptions = <
...
>(
  ...
  const queryOptions = getFleetVehiclesQueryOptions(fleetSlug, params, options);
...
export const getPublicFleetStatsModelCountsQueryOptions = <
...
>(
  ...
  const queryOptions = getPublicFleetStatsModelCountsQueryOptions(
    fleetSlug,
    params,
    options,
  );
...
export const getPublicFleetVehiclesEmbedQueryOptions = <
...
>(
  ...
  const queryOptions = getPublicFleetVehiclesEmbedQueryOptions(
    fleetSlug,
    params,
    options,
  );
...
export const getPublicFleetVehiclesQueryOptions = <
...
>(
  ...
  const queryOptions = getPublicFleetVehiclesQueryOptions(
    fleetSlug,
    params,
    options,
  );
