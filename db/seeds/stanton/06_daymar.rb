...
daymar = CelestialObject.find_or_initialize_by(name: 'Daymar')
daymar.update!(store_image: Rails.root.join('db/seeds/images/daymar/daymar.jpg').open)

corvolex_shipping = Station.find_or_initialize_by(name: 'Covalex Hub Gundo')
corvolex_shipping.update!(celestial_object: daymar, station_type: 'cargo-station', location: 'Orbit')

shubin = Station.find_or_initialize_by(name: 'Shubin Mining Facility SCD-1')
shubin.update!(celestial_object: daymar, station_type: :outpost, location: 'Daymar')
...
arccorp.update!(celestial_object: daymar, station_type: :outpost, location: 'Daymar')
...
kudre_ore.update!(celestial_object: daymar, station_type: :outpost, location: 'Daymar')
...
bountiful_harvest.update!(celestial_object: daymar, station_type: :outpost, location: 'Daymar')
...
eager_flats.update!(celestial_object: daymar, station_type: :aid_shelter, location: 'Daymar')

wolf_point = Station.find_or_initialize_by(name: 'Wolf Point Aid Shelter')
wolf_point.update!(celestial_object: daymar, station_type: :aid_shelter, location: 'Daymar')

tamdon_plains = Station.find_or_initialize_by(name: 'Tamdon Plains Aid Shelter')
tamdon_plains.update!(celestial_object: daymar, station_type: :aid_shelter, location: 'Daymar')

dunlow_ridge = Station.find_or_initialize_by(name: 'Dunlow Ridge Aid Shelter')
dunlow_ridge.update!(celestial_object: daymar, station_type: :aid_shelter, location: 'Daymar')
