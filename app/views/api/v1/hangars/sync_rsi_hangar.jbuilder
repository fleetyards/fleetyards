...
json.imported_upgrades @response[:imported_upgrades]
json.found_upgrades @response[:found_upgrades]
json.missing_upgrades @response[:missing_upgrades]
json.missing_upgrade_vehicles @response[:missing_upgrade_vehicles]
