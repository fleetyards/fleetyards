...
* **admin:** edit what a berth is built for ([#5092](https://github.com/fleetyards/fleetyards/issues/5092)) ([941aa91](https://github.com/fleetyards/fleetyards/commit/941aa914924b248192bd2f5e4342f146221b45e4))
...
* **blueprints:** compare a holding against a cost stated in the other unit ([#5047](https://github.com/fleetyards/fleetyards/issues/5047)) ([638823b](https://github.com/fleetyards/fleetyards/commit/638823b52212caefd2a76bdb9bf4b0d143717b9e))
...
* **components:** publish the tags an item carries ([#5096](https://github.com/fleetyards/fleetyards/issues/5096)) ([4f8b6f3](https://github.com/fleetyards/fleetyards/commit/4f8b6f3b8de93ae056e3cb6b7b90c88682c2984b))
* **components:** say what a component costs, and what it means when nothing does ([#5097](https://github.com/fleetyards/fleetyards/issues/5097)) ([72c6d91](https://github.com/fleetyards/fleetyards/commit/72c6d911ea55ec1f02fbf681f119535e04389ab3))
...
* **docks:** answer will-it-fit from the class, not the envelope ([#5099](https://github.com/fleetyards/fleetyards/issues/5099)) ([2ebf057](https://github.com/fleetyards/fleetyards/commit/2ebf05718100eaf5c6f4315b5f35f9bb0947a6f0))
* **docks:** name the ships a berth takes beyond its class ([#5098](https://github.com/fleetyards/fleetyards/issues/5098)) ([50f3b84](https://github.com/fleetyards/fleetyards/commit/50f3b84b68849dc6377c5afe7c37235993212ea2))
* **docks:** record what a berth is built for ([#5089](https://github.com/fleetyards/fleetyards/issues/5089)) ([88d47fb](https://github.com/fleetyards/fleetyards/commit/88d47fb08def47a5996a1f92214f1de4ad48b527))
* **docks:** say how a berth is reached ([#5086](https://github.com/fleetyards/fleetyards/issues/5086)) ([af018da](https://github.com/fleetyards/fleetyards/commit/af018daeb789a6830389fba72458624b94ac7b35))
...
* **models:** seed the vehicle size ladder ([#5074](https://github.com/fleetyards/fleetyards/issues/5074)) ([f3237fe](https://github.com/fleetyards/fleetyards/commit/f3237fe0deb56cc722f9ae98a6ce58b120bb4694))
* **models:** set the pad class from the holo measurement ([#5088](https://github.com/fleetyards/fleetyards/issues/5088)) ([acfc556](https://github.com/fleetyards/fleetyards/commit/acfc5568fc64c7a2b470b95b7c297354e020cee2))
...
* **blueprints:** convert only a unit the comparison recognises ([#5049](https://github.com/fleetyards/fleetyards/issues/5049)) ([6de5740](https://github.com/fleetyards/fleetyards/commit/6de574024c55b67d1a4e46a95e1af92e057d9370))
* **ci:** let a run without object-storage credentials reuse the cached tree ([#5115](https://github.com/fleetyards/fleetyards/issues/5115)) ([ace3614](https://github.com/fleetyards/fleetyards/commit/ace36144c37146255aca41b9b822168c1b314bca))
* **docks:** correct three hangar sizes ([#5078](https://github.com/fleetyards/fleetyards/issues/5078)) ([9ee1b35](https://github.com/fleetyards/fleetyards/commit/9ee1b358af36d8237c16b76d7c7872230c029fe2))
...
* **forms:** a name with no placeholder key renders nothing, not the missing marker ([6eb6af4](https://github.com/fleetyards/fleetyards/commit/6eb6af40676c966dfa90bfe65a73fe964b6b9d66))
...
* **holo-viewer:** cap how steeply the camera looks down ([#5116](https://github.com/fleetyards/fleetyards/issues/5116)) ([4f7adbc](https://github.com/fleetyards/fleetyards/commit/4f7adbc43298660b8fdbec4c9b24b21d51920f95))
* **i18n:** the admin vehicle "hidden" toggle had no label ([7aa3205](https://github.com/fleetyards/fleetyards/commit/7aa3205ccde0a290738bd3b61eaf13dae8ab213c))
...
* **models:** clear a size the catalogue does not know ([#5083](https://github.com/fleetyards/fleetyards/issues/5083)) ([239a603](https://github.com/fleetyards/fleetyards/commit/239a603365e4828fe2726aa0ef6a6e06f0201f39))
* **models:** give the size column a vocabulary, and fill the ten vehicles missing one ([#5073](https://github.com/fleetyards/fleetyards/issues/5073)) ([38eb052](https://github.com/fleetyards/fleetyards/commit/38eb0527c02a6fb9cc6bb0d227f3c5172125b5bb))
* **models:** make the four mixed variant families consistent ([#5080](https://github.com/fleetyards/fleetyards/issues/5080)) ([b3c1e70](https://github.com/fleetyards/fleetyards/commit/b3c1e707f603b1fb8be4f07325d44d8cbc133038))
* **models:** the pad class comes from the landed box ([#5091](https://github.com/fleetyards/fleetyards/issues/5091)) ([f59157b](https://github.com/fleetyards/fleetyards/commit/f59157b4ada5a5cdd6725af42e6cbea790e736a7))
...
* **sc_data:** let cache-key answer without 1Password ([#5117](https://github.com/fleetyards/fleetyards/issues/5117)) ([1bde1de](https://github.com/fleetyards/fleetyards/commit/1bde1de3dc93aab0ddf7f5b180a2f7ee2ec54c9e))
...
* **test:** scope the components sort probe away from Faker's surnames ([#5054](https://github.com/fleetyards/fleetyards/issues/5054)) ([46946b9](https://github.com/fleetyards/fleetyards/commit/46946b9941050365bb0ac343e6c5d0ea893e28e2))
* **test:** the Merchantman's berth is a landing pad, not a vehicle pad ([#5085](https://github.com/fleetyards/fleetyards/issues/5085)) ([4cddb09](https://github.com/fleetyards/fleetyards/commit/4cddb09a0ceac36471002b285307634f03a5ea88))
* **test:** type the FormInput mount helper against the component's props ([bb2b1f5](https://github.com/fleetyards/fleetyards/commit/bb2b1f5c637f663fffddad513f8c42ef4278e372))


### Refactorings

* **docks:** drop the model_id the polymorphic parent replaced ([#5069](https://github.com/fleetyards/fleetyards/issues/5069)) ([69ea627](https://github.com/fleetyards/fleetyards/commit/69ea62710041d4a3f7465c26a91cf7c39469c501))


### Chores

* **annotations:** align the component_build_changes index comments ([bf86036](https://github.com/fleetyards/fleetyards/commit/bf860361290af66fc66aec0e087067c1c6176337))
* **build:** generate the frontend clients from Vite, not from the install ([#5077](https://github.com/fleetyards/fleetyards/issues/5077)) ([82870b3](https://github.com/fleetyards/fleetyards/commit/82870b3290e628ae16216b91b0e962eb3e5b51e3))
...
* **deploy:** move the pre-deploy steps into bin/deploy-release ([b28737c](https://github.com/fleetyards/fleetyards/commit/b28737ce2d9db2f94eae5f12114773272f9d1c5a))
...
* **logistics:** itemCount is gone from the fleet, hangar and vehicle inventory payloads. Inventories are a beta feature.

### Features

* **admin:** admin notifications and notification center ([#4404](https://github.com/fleetyards/fleetyards/issues/4404)) ([3d0ca33](https://github.com/fleetyards/fleetyards/commit/3d0ca33f62810b4d9977a2b87dcd2aa672d97017))
* **admin:** commodity and equipment reference tables ([#4431](https://github.com/fleetyards/fleetyards/issues/4431)) ([9d78f4f](https://github.com/fleetyards/fleetyards/commit/9d78f4f0f626655979580a088f7ff7cb4af36a0c))
* **admin:** show this month on the supporter contributions stats ([c036d8d](https://github.com/fleetyards/fleetyards/commit/c036d8dd1ffae324a85a2a7f5e9d3d5f50a33658))
* **catalogues:** carry the export's artwork onto the records ([#4409](https://github.com/fleetyards/fleetyards/issues/4409)) ([ace5bd1](https://github.com/fleetyards/fleetyards/commit/ace5bd1b2072e1f23436ed7a1c3da271849b5d57))
* **commodities:** add Commodity reference table from game files ([#4385](https://github.com/fleetyards/fleetyards/issues/4385)) ([d26a249](https://github.com/fleetyards/fleetyards/commit/d26a2490f7c2a77c233e48de297ac5c76401d38d))
* **compare:** rework the compare page into one sticky metrics table ([#4363](https://github.com/fleetyards/fleetyards/issues/4363)) ([2eccfc0](https://github.com/fleetyards/fleetyards/commit/2eccfc01b0ea33d8531fdf3c1f0c28ed41b78861))
* **credits:** credit erkul on the ship metrics and in the imprint ([#4442](https://github.com/fleetyards/fleetyards/issues/4442)) ([d8786b5](https://github.com/fleetyards/fleetyards/commit/d8786b5e2f63b1de611fe12aaf824c11c1a15717))
* **equipment:** consumables ([#4403](https://github.com/fleetyards/fleetyards/issues/4403)) ([c461649](https://github.com/fleetyards/fleetyards/commit/c461649cf0b17c32212d1a3c043651cd1ae21170))
* **equipment:** load armour and clothing into the same table ([#4392](https://github.com/fleetyards/fleetyards/issues/4392)) ([db7b486](https://github.com/fleetyards/fleetyards/commit/db7b4864f08b0f52f6eb48bdb5e6379ec8587b70))
* **equipment:** personal gear reference table from game files ([#4396](https://github.com/fleetyards/fleetyards/issues/4396)) ([cb90bd7](https://github.com/fleetyards/fleetyards/commit/cb90bd77dd1201b1fea2ebc48eb8509ae0835710))
* **feature-flags:** declare fleet_mission_builder ([#4443](https://github.com/fleetyards/fleetyards/issues/4443)) ([6d13dae](https://github.com/fleetyards/fleetyards/commit/6d13daeb5b8661b90abc13e2aa44700981b07f58))
* **feature-flags:** declare self-service in the registry ([#4390](https://github.com/fleetyards/fleetyards/issues/4390)) ([c4cdeea](https://github.com/fleetyards/fleetyards/commit/c4cdeea5b4f4d127fa489ed5355a8852ce0ce433))
* **feature-flags:** make config/feature_flags.yml the source of truth ([#4341](https://github.com/fleetyards/fleetyards/issues/4341)) ([a5f7e23](https://github.com/fleetyards/fleetyards/commit/a5f7e2347c54776531f3479fcaa8058fb597466a))
* **fleets:** add hangar.link-compatible export ([8772b61](https://github.com/fleetyards/fleetyards/commit/8772b613cc19e5f63ca312a9ab23e5177475b172))
* **fleets:** calendar feeds and ICS downloads ([#4463](https://github.com/fleetyards/fleetyards/issues/4463)) ([e5f3d29](https://github.com/fleetyards/fleetyards/commit/e5f3d29566afa4bcd9c9379997cb8d2a0e13ee2e))
* **fleets:** event notifications and the Discord sync ([#4448](https://github.com/fleetyards/fleetyards/issues/4448)) ([65527e6](https://github.com/fleetyards/fleetyards/commit/65527e6d690c45c78db1f08f51157f891dc54182))
* **fleets:** fleet events ([#4446](https://github.com/fleetyards/fleetyards/issues/4446)) ([ce160b6](https://github.com/fleetyards/fleetyards/commit/ce160b699f09236cdbd706843d918f99319bfdfc))
* **fleets:** fleet missions ([#4445](https://github.com/fleetyards/fleetyards/issues/4445)) ([53167fb](https://github.com/fleetyards/fleetyards/commit/53167fb99b71aabe853b08dad5b52f660fb0260d))
* **fleets:** fleet-scoped feature flags with a fleet settings Features tab ([#4444](https://github.com/fleetyards/fleetyards/issues/4444)) ([cfe5c67](https://github.com/fleetyards/fleetyards/commit/cfe5c676bef64aa60a42b75dd3957f75550ccc61))
* **fleets:** the events and calendar UI ([#3893](https://github.com/fleetyards/fleetyards/issues/3893)) ([f50b62f](https://github.com/fleetyards/fleetyards/commit/f50b62f921b531e6e17acc0e942b9e6b568740a6))
* **fleets:** the mission builder UI ([#4449](https://github.com/fleetyards/fleetyards/issues/4449)) ([4311527](https://github.com/fleetyards/fleetyards/commit/43115279976defe3e59d8d3080e9eaa2781e266b))
* **hangar:** personal hangar inventories ([#4340](https://github.com/fleetyards/fleetyards/issues/4340)) ([b66f77b](https://github.com/fleetyards/fleetyards/commit/b66f77b2782a31c6356af40c6e2686c1442cef89))
* **hangar:** ship inventories ([#4375](https://github.com/fleetyards/fleetyards/issues/4375)) ([5cb5f15](https://github.com/fleetyards/fleetyards/commit/5cb5f15263e2dd611a8feb07b9c1be3132df531d))
* **loadout:** interactive power-distribution UI + metrics cards ([#4314](https://github.com/fleetyards/fleetyards/issues/4314)) ([888a24e](https://github.com/fleetyards/fleetyards/commit/888a24ea1dc63dae8451290af29878c6d6b3add5))
* **logistics:** flag inventory entries holding gear the current build dropped ([#4402](https://github.com/fleetyards/fleetyards/issues/4402)) ([10518d4](https://github.com/fleetyards/fleetyards/commit/10518d4d080398cea6df3ff275dcbb3643180f28))
* **logistics:** pick commodities in inventory entries ([#4386](https://github.com/fleetyards/fleetyards/issues/4386)) ([cc2aac4](https://github.com/fleetyards/fleetyards/commit/cc2aac44cb00f7e83d8347fbeef607ffe813e236))
* **metrics:** measure API-only and third-party activity ([#4357](https://github.com/fleetyards/fleetyards/issues/4357)) ([3c75542](https://github.com/fleetyards/fleetyards/commit/3c75542dbd17da3a80a2c5f32c14bba79c7ed882))
* **models:** trim padding from view uploads, and upload views by the folder ([#4465](https://github.com/fleetyards/fleetyards/issues/4465)) ([87a3ffb](https://github.com/fleetyards/fleetyards/commit/87a3ffb827daea44c8431d4632aba622c6b119eb))
* **paints:** component icons, and curated artwork onto components ([#4434](https://github.com/fleetyards/fleetyards/issues/4434)) ([4ca2b76](https://github.com/fleetyards/fleetyards/commit/4ca2b76353ffb8c108b70ee7ec34d1d7a971194c))
* **privacy:** make the analytics opt-out real ([#4356](https://github.com/fleetyards/fleetyards/issues/4356)) ([df01a5c](https://github.com/fleetyards/fleetyards/commit/df01a5cc0d4ec81b83cc921ae7716b5361b9aefc))
* **sc-data:** read ground vehicle speeds from the vehicle definition ([#4384](https://github.com/fleetyards/fleetyards/issues/4384)) ([39ef5ab](https://github.com/fleetyards/fleetyards/commit/39ef5abe73b9b2fb46f166f6187f9ce5ee31e39b))
* **sc-data:** serve commodity icons as SVG instead of rasterizing them ([#4451](https://github.com/fleetyards/fleetyards/issues/4451)) ([3e447be](https://github.com/fleetyards/fleetyards/commit/3e447be3c986fc289d4f5020d07acff81a0271bd))
* **supporters:** link a contribution to a user account ([#4460](https://github.com/fleetyards/fleetyards/issues/4460)) ([adf8b96](https://github.com/fleetyards/fleetyards/commit/adf8b9625a7400cd8db320456948cb8009f635ed))
* **supporters:** monthly contribution stats in the admin area ([#4459](https://github.com/fleetyards/fleetyards/issues/4459)) ([83acfd9](https://github.com/fleetyards/fleetyards/commit/83acfd9deabca470565c65b3e07e65b8431bf1d8))
* **uex:** map commodities to their UEX ids ([#4387](https://github.com/fleetyards/fleetyards/issues/4387)) ([4727d23](https://github.com/fleetyards/fleetyards/commit/4727d237bba62c720bce9d9ba0472022eb98198b))
* **uex:** sync commodity prices ([#4389](https://github.com/fleetyards/fleetyards/issues/4389)) ([29f631c](https://github.com/fleetyards/fleetyards/commit/29f631c3b61b3787725f501599b30e7214968d34))
* **ui:** redesign the Btn component ([#4338](https://github.com/fleetyards/fleetyards/issues/4338)) ([7506548](https://github.com/fleetyards/fleetyards/commit/7506548651ff372bde3ef40936c71523cf76e95c))
* **ui:** redesign the Panel component ([#4362](https://github.com/fleetyards/fleetyards/issues/4362)) ([060004e](https://github.com/fleetyards/fleetyards/commit/060004e4eae199d0fd5aee64e9b8e970bf07860b))
* **visual-tests:** add metrics, lists, forms, typography and states pages ([#4339](https://github.com/fleetyards/fleetyards/issues/4339)) ([198a69d](https://github.com/fleetyards/fleetyards/commit/198a69d5bef5ec47e98d367b920267da2e09d698))


### Bug Fixes

* **admin:** hold the chart panel height while the chart loads ([#4466](https://github.com/fleetyards/fleetyards/issues/4466)) ([16d2bc6](https://github.com/fleetyards/fleetyards/commit/16d2bc6b7bd144d206cce4e440db76e7c5180930))
* **deps:** drop duplicated string-width entry from pnpm-lock ([428cc3f](https://github.com/fleetyards/fleetyards/commit/428cc3fed61bcc9bd3241e3be7765681ef35549c))
* **deps:** record gem checksums so a frozen install can verify them ([efb3407](https://github.com/fleetyards/fleetyards/commit/efb340764e06e9e998124aee45447dcb271d8e5b))
* **dev:** name the rdbg session after this app ([#4342](https://github.com/fleetyards/fleetyards/issues/4342)) ([95295cb](https://github.com/fleetyards/fleetyards/commit/95295cb52495ff668bb823c08245eba9dec46372))
* **docker:** copy the pnpm patch directory before installing ([414ad01](https://github.com/fleetyards/fleetyards/commit/414ad01f90f3571062f2b8c7cf6dda76d658f4b1))
* **download-uploads:** make the sync incremental and resumable ([c2135a2](https://github.com/fleetyards/fleetyards/commit/c2135a2fda089f96d9c5d7ce5fd8b4e84ffef153))
* **download-uploads:** report why a batch failed ([ebfb322](https://github.com/fleetyards/fleetyards/commit/ebfb322139c97fd83f0471c4233a16526a9f795c))
* **form-input:** apply the error border colour to prefix and suffix ([b21dbb3](https://github.com/fleetyards/fleetyards/commit/b21dbb3c68515171c8a8a9171ce9bbd7f7bdecb3))
* **form-input:** stop suffix text from wrapping and breaking alignment ([e00444f](https://github.com/fleetyards/fleetyards/commit/e00444f7b94be13b3b6508ef586ebe9506ac120c))
* **gitignore:** ignore dumps by name so the worktree symlink is covered ([f2c64b4](https://github.com/fleetyards/fleetyards/commit/f2c64b40fec715671e413e32d2da962720a3af01))
* **loaders:** handle new ship matrix sizes and types ([#4332](https://github.com/fleetyards/fleetyards/issues/4332)) ([c5c81ca](https://github.com/fleetyards/fleetyards/commit/c5c81ca5a66b4ec427e6afc18e093d02cd564794))
* **release:** read the codename from config/release.yml at boot ([6ecb4cb](https://github.com/fleetyards/fleetyards/commit/6ecb4cbcbf9668c7b0702c546f426da881db4682))
* **sc_data:** retire catalogue records a re-imported build no longer ships ([#4401](https://github.com/fleetyards/fleetyards/issues/4401)) ([ba73dfc](https://github.com/fleetyards/fleetyards/commit/ba73dfc57c84dc25833f145d6aee203a4ae99010))
* **sc_data:** stop the export minting duplicate manufacturers ([#4432](https://github.com/fleetyards/fleetyards/issues/4432)) ([2b5b548](https://github.com/fleetyards/fleetyards/commit/2b5b548b59f4df640eaf8b67ba7a36e6125c6fbc))
* **setup:** give each worktree its own test database ([#4388](https://github.com/fleetyards/fleetyards/issues/4388)) ([7aa8ff6](https://github.com/fleetyards/fleetyards/commit/7aa8ff68b4b39a418326da9a9ca9826d62246bb3))
* **setup:** isolate worktree Redis databases and stop slots drifting ([#4458](https://github.com/fleetyards/fleetyards/issues/4458)) ([55baf09](https://github.com/fleetyards/fleetyards/commit/55baf09b3061d9d838d4718236516ad78bcc7a1a))
* **setup:** stop worktrees colliding on dev ports and Redis databases ([#4437](https://github.com/fleetyards/fleetyards/issues/4437)) ([98f68d0](https://github.com/fleetyards/fleetyards/commit/98f68d0bfd6a6d2d2379583680f05526af028836))
* **sidekiq:** broadcast Sidekiq logs to AppSignal ([#4337](https://github.com/fleetyards/fleetyards/issues/4337)) ([3b74ef6](https://github.com/fleetyards/fleetyards/commit/3b74ef60d6d166d76fcce24fe094415e0cc96802)), closes [#4336](https://github.com/fleetyards/fleetyards/issues/4336)
* **stats:** make the stat tile icon legible ([59808b2](https://github.com/fleetyards/fleetyards/commit/59808b2fd754f81ed1b610b28632f7278b64d0d6))
* **tooltip:** stop tooltips getting stranded on screen ([#4457](https://github.com/fleetyards/fleetyards/issues/4457)) ([3804c3c](https://github.com/fleetyards/fleetyards/commit/3804c3c5f40e94ad9ba96185663e879de2f414a2))
* **validation-error:** camelize attribute names so clients can map them to fields ([#4364](https://github.com/fleetyards/fleetyards/issues/4364)) ([0df682d](https://github.com/fleetyards/fleetyards/commit/0df682d2faf4c02c4e1261adf3c67e228f0fd824))


### Refactorings

* **components:** one row per component, history as versions ([#4399](https://github.com/fleetyards/fleetyards/issues/4399)) ([a81b63b](https://github.com/fleetyards/fleetyards/commit/a81b63b6ed99692883cb8b52c314455fdf9c813a))
* **download-uploads:** pass s3 credentials via the environment ([4e8fd3b](https://github.com/fleetyards/fleetyards/commit/4e8fd3ba65188a187f6eb795952ac90f01086206))
* **feature-flags:** replace the rake tasks with bin/feature-flags ([#4430](https://github.com/fleetyards/fleetyards/issues/4430)) ([9aa5ab2](https://github.com/fleetyards/fleetyards/commit/9aa5ab240f6a2cc2c2429bf7c20f17c34dd65519))
* **logistics:** count inventory entries, not items ([#4428](https://github.com/fleetyards/fleetyards/issues/4428)) ([669a5ed](https://github.com/fleetyards/fleetyards/commit/669a5eda2e2e0914c6733be48c26b3dfa81ad381))


### Chores

* **annotations:** add schema annotation to item price test ([f6ad70b](https://github.com/fleetyards/fleetyards/commit/f6ad70b179e0de2a404d742fc45428565343ad0d))
* **credentials:** rotate the hetzner s3 keys and drop carrierwave ([97388e2](https://github.com/fleetyards/fleetyards/commit/97388e22ae3609ebaa13c408abb9360491865381))
* **deps-dev:** bump @faker-js/faker from 10.5.0 to 10.6.0 ([#4439](https://github.com/fleetyards/fleetyards/issues/4439)) ([821eec4](https://github.com/fleetyards/fleetyards/commit/821eec45aa9328d6386afe3ce8f3eea9e1d09aa0))
* **deps-dev:** bump @types/node from 26.1.2 to 26.2.0 ([#4355](https://github.com/fleetyards/fleetyards/issues/4355)) ([e411331](https://github.com/fleetyards/fleetyards/commit/e41133157c5b8bda2e64a2271463c5eb637d7aec))
* **deps-dev:** bump @types/three from 0.184.1 to 0.185.4 ([#4421](https://github.com/fleetyards/fleetyards/issues/4421)) ([7ea9f60](https://github.com/fleetyards/fleetyards/commit/7ea9f60cff81a310ed6972731a0e23ccb22b4899))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([#4354](https://github.com/fleetyards/fleetyards/issues/4354)) ([42f28d3](https://github.com/fleetyards/fleetyards/commit/42f28d335deee5f3ceeabbbc7394bbbf2adfe08c))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([#4438](https://github.com/fleetyards/fleetyards/issues/4438)) ([d98c648](https://github.com/fleetyards/fleetyards/commit/d98c64836b72a51f0fd2aa910db7cb009bd6013b))
* **deps-dev:** bump @typescript-eslint/parser from 8.66.0 to 8.67.0 ([#4420](https://github.com/fleetyards/fleetyards/issues/4420)) ([2640f7a](https://github.com/fleetyards/fleetyards/commit/2640f7af27c92933f56f64396c6feb55af9aa414))
* **deps-dev:** bump c8 from 11.0.0 to 12.0.0 ([#4350](https://github.com/fleetyards/fleetyards/issues/4350)) ([0037ead](https://github.com/fleetyards/fleetyards/commit/0037ead055bfb8831b3ee5832fd78930e5dce635))
* **deps-dev:** bump concurrently from 10.0.4 to 10.0.5 ([#4453](https://github.com/fleetyards/fleetyards/issues/4453)) ([3154c48](https://github.com/fleetyards/fleetyards/commit/3154c48c4e000fd8b290fc343a9fc2c54d96d87f))
* **deps-dev:** bump eslint from 10.6.0 to 10.8.1 ([#4351](https://github.com/fleetyards/fleetyards/issues/4351)) ([042e66b](https://github.com/fleetyards/fleetyards/commit/042e66b5d9cbe07b995cf1f0d3cb240eab784300))
* **deps-dev:** bump eslint-plugin-vuejs-accessibility ([#4352](https://github.com/fleetyards/fleetyards/issues/4352)) ([f0a0c72](https://github.com/fleetyards/fleetyards/commit/f0a0c72dc23f8d73b798ab99c0c6e0feb55fc5cb))
* **deps-dev:** bump globals from 17.9.0 to 17.11.0 ([#4425](https://github.com/fleetyards/fleetyards/issues/4425)) ([8023f91](https://github.com/fleetyards/fleetyards/commit/8023f91a2ded6813d0f9c3dab701cf3742a8ebb0))
* **deps-dev:** bump jsdom from 29.1.1 to 30.0.1 ([#4325](https://github.com/fleetyards/fleetyards/issues/4325)) ([eacd170](https://github.com/fleetyards/fleetyards/commit/eacd170cf79aba0af3f3644f5ae55bada59c00fd))
* **deps-dev:** bump knip from 6.32.0 to 6.32.2 ([#4424](https://github.com/fleetyards/fleetyards/issues/4424)) ([6ddd061](https://github.com/fleetyards/fleetyards/commit/6ddd061b0c19084e8d78928658648b5e21227330))
* **deps-dev:** bump mocha from 11.7.6 to 11.8.0 ([#4324](https://github.com/fleetyards/fleetyards/issues/4324)) ([b6ff53b](https://github.com/fleetyards/fleetyards/commit/b6ff53b57417a95f876c06887b28e50cdc59fae0))
* **deps-dev:** bump msw from 2.14.6 to 2.15.0 ([#4348](https://github.com/fleetyards/fleetyards/issues/4348)) ([a88de1e](https://github.com/fleetyards/fleetyards/commit/a88de1e9bcc97d54f3fadf744fb9dc3f90eb8e76))
* **deps-dev:** bump orval from 8.23.0 to 8.24.0 ([#4326](https://github.com/fleetyards/fleetyards/issues/4326)) ([96958c0](https://github.com/fleetyards/fleetyards/commit/96958c0e78c75155c748c8a88ca9838c918c373e))
* **deps-dev:** bump simplecov from 1.0.3 to 1.1.0 ([#4358](https://github.com/fleetyards/fleetyards/issues/4358)) ([2355b63](https://github.com/fleetyards/fleetyards/commit/2355b634b59f8d69d06c367beb2e6e0db4040aa4))
* **deps-dev:** bump simplecov from 1.1.0 to 1.1.1 ([#4419](https://github.com/fleetyards/fleetyards/issues/4419)) ([b1318a1](https://github.com/fleetyards/fleetyards/commit/b1318a1154872ced69590cf1383fe102effe4b16))
* **deps-dev:** bump stylelint from 17.13.0 to 17.14.1 ([#4347](https://github.com/fleetyards/fleetyards/issues/4347)) ([3b3b037](https://github.com/fleetyards/fleetyards/commit/3b3b037d082986216b7e04705ec6d68f46635671))
* **deps-dev:** bump vue-component-type-helpers from 3.3.9 to 3.3.10 ([#4454](https://github.com/fleetyards/fleetyards/issues/4454)) ([dc830bd](https://github.com/fleetyards/fleetyards/commit/dc830bd85b8e3415b39946d1f1489a005536dd5e))
* **deps-dev:** bump vue-tsc from 3.3.9 to 3.3.10 ([#4455](https://github.com/fleetyards/fleetyards/issues/4455)) ([50669a9](https://github.com/fleetyards/fleetyards/commit/50669a931b9f49466745b54edeab8d74c853879c))
* **deps:** bump appsignal from 4.9.1 to 4.10.0 ([#4359](https://github.com/fleetyards/fleetyards/issues/4359)) ([3272206](https://github.com/fleetyards/fleetyards/commit/3272206ca732cfaa7ace045479f97554a5b4b7c7))
* **deps:** bump bootsnap from 1.24.6 to 1.25.0 ([#4319](https://github.com/fleetyards/fleetyards/issues/4319)) ([cae32af](https://github.com/fleetyards/fleetyards/commit/cae32af7181d9ba0bc280f67bf296102f1666335))
* **deps:** bump core-js from 3.49.0 to 3.50.0 ([#4344](https://github.com/fleetyards/fleetyards/issues/4344)) ([2b1bc18](https://github.com/fleetyards/fleetyards/commit/2b1bc1801c2e3a271edf76b60a846c5240814d7a))
* **deps:** bump doorkeeper from 5.9.5 to 5.9.6 ([#4381](https://github.com/fleetyards/fleetyards/issues/4381)) ([9f6e2d0](https://github.com/fleetyards/fleetyards/commit/9f6e2d0bec8d51035755d74a84a6b10e0152be21))
* **deps:** bump git from 5.0.4 to 5.0.5 ([#4346](https://github.com/fleetyards/fleetyards/issues/4346)) ([6c64fa2](https://github.com/fleetyards/fleetyards/commit/6c64fa2066bceddcd78ba07b492590e06e54c6d2))
* **deps:** bump highcharts from 13.0.0 to 13.0.1 ([#4462](https://github.com/fleetyards/fleetyards/issues/4462)) ([ef700e8](https://github.com/fleetyards/fleetyards/commit/ef700e86f3d2902b322cbcccecde7e15524fcaee))
* **deps:** bump highlight.js from 11.11.1 to 11.12.0 ([#4427](https://github.com/fleetyards/fleetyards/issues/4427)) ([6944bab](https://github.com/fleetyards/fleetyards/commit/6944babaf5940eaaf355dee9023a8b6015049e90))
* **deps:** bump oj from 3.17.5 to 3.17.6 ([#4360](https://github.com/fleetyards/fleetyards/issues/4360)) ([a00d09c](https://github.com/fleetyards/fleetyards/commit/a00d09cac6abab2838f0e59604788a0caffcae22))
* **deps:** bump openapi-ruby from 4.0.1 to 4.1.0 ([#4361](https://github.com/fleetyards/fleetyards/issues/4361)) ([184e5d4](https://github.com/fleetyards/fleetyards/commit/184e5d4f77dd178358cd639235b3598fa122fc3c))
* **deps:** bump papaparse from 5.5.4 to 5.6.0 ([#4423](https://github.com/fleetyards/fleetyards/issues/4423)) ([f75ead3](https://github.com/fleetyards/fleetyards/commit/f75ead33f5ef8e8942cf288e5e880f48e79b6595))
* **deps:** bump pghero from 4.0.0 to 4.0.1 ([#4452](https://github.com/fleetyards/fleetyards/issues/4452)) ([6d90c5c](https://github.com/fleetyards/fleetyards/commit/6d90c5c01a3d3faf6f6bc49ab2831e5105170979))
* **deps:** bump pinia from 3.0.4 to 4.0.3 ([#4418](https://github.com/fleetyards/fleetyards/issues/4418)) ([86e9656](https://github.com/fleetyards/fleetyards/commit/86e9656579ebead8aaad90e4cffabcf79bfa00ee))
* **deps:** bump sidekiq from 8.1.6 to 8.1.7 ([#4461](https://github.com/fleetyards/fleetyards/issues/4461)) ([5a61cc9](https://github.com/fleetyards/fleetyards/commit/5a61cc9ec6e4c401252d457659921121ca40bf9e))
* **deps:** bump swagger-ui-dist from 5.32.12 to 5.32.13 ([#4422](https://github.com/fleetyards/fleetyards/issues/4422)) ([b6ffd85](https://github.com/fleetyards/fleetyards/commit/b6ffd85ed1356a4abacfd9ab38c4ead7579e0883))
* **deps:** bump three from 0.184.0 to 0.185.1 ([#4353](https://github.com/fleetyards/fleetyards/issues/4353)) ([e050a4a](https://github.com/fleetyards/fleetyards/commit/e050a4a494303bbd8a71e0466ffd8f60901c12b4))
* **deps:** bump vue-router from 5.1.0 to 5.2.0 ([#4349](https://github.com/fleetyards/fleetyards/issues/4349)) ([66629a5](https://github.com/fleetyards/fleetyards/commit/66629a58137d9d041516e3e33ccdb062a4162cb7))
* **deps:** bump vue-upload-component from 3.1.17 to 3.2.0 ([#4426](https://github.com/fleetyards/fleetyards/issues/4426)) ([e01901f](https://github.com/fleetyards/fleetyards/commit/e01901fff831147975d98487454bdfd23297a04f))
* **deps:** patch @tresjs/core for @types/three 0.185 ([#4429](https://github.com/fleetyards/fleetyards/issues/4429)) ([6eac76d](https://github.com/fleetyards/fleetyards/commit/6eac76db90f6857c80b32440eb8ec57c1786d31c))
* **deps:** tell dependabot to skip redis 6 ([#4380](https://github.com/fleetyards/fleetyards/issues/4380)) ([f71311d](https://github.com/fleetyards/fleetyards/commit/f71311d0795239712dec5457a077113a7ac7e073))
* **feature-flags:** use the FeatureFlagName enum in the frontend and retire hardpoints-v2 ([#4393](https://github.com/fleetyards/fleetyards/issues/4393)) ([fc93cc7](https://github.com/fleetyards/fleetyards/commit/fc93cc7c1a05e6c84ea1052f84d22a602efed4ce))
* **greptile:** skip generated sc_data dumps in review ([#4408](https://github.com/fleetyards/fleetyards/issues/4408)) ([ac32e46](https://github.com/fleetyards/fleetyards/commit/ac32e463fd621f0d9030bb59a5d238845a4cb215))
* pin redis to 7.2.15 across CI, dev, and prod ([#4333](https://github.com/fleetyards/fleetyards/issues/4333)) ([bc552fc](https://github.com/fleetyards/fleetyards/commit/bc552fc4698db1435db72c9280230aae675d88cc))
* **release:** name 7.0.0 Stingray ([166f80c](https://github.com/fleetyards/fleetyards/commit/166f80c274883c26c890e3c0639f100f78e511f1))
* **setup:** share uploads and db dumps across worktrees ([9f7e58d](https://github.com/fleetyards/fleetyards/commit/9f7e58d1eda35ca36c9540284d41b907bcf14dd0))
* **skills:** add deps triage skill ([#4368](https://github.com/fleetyards/fleetyards/issues/4368)) ([79e43fd](https://github.com/fleetyards/fleetyards/commit/79e43fd288e173d468a8d20357a3374dfc3cf649))
...
* **api:** add ComponentArmor schema; type the armor frontend branch ([#4265](https://github.com/fleetyards/fleetyards/issues/4265)) ([ab497cf](https://github.com/fleetyards/fleetyards/commit/ab497cf9a7bdebd7f1250547b4111a4208f40e7d))
* **api:** expose component signatures, power ranges + cross-section ([#4313](https://github.com/fleetyards/fleetyards/issues/4313)) ([8dcb41f](https://github.com/fleetyards/fleetyards/commit/8dcb41fbf70417d29ce37da74b3080672996130f))
...
* **hardpoints:** Defense + Hull panes, armor integration and deflection check ([#4289](https://github.com/fleetyards/fleetyards/issues/4289)) ([820464f](https://github.com/fleetyards/fleetyards/commit/820464f364d54d0f5ae4faeb88c8be9df5e9e9cf))
...
* **sc-data:** load ship cross-section signature ([#4312](https://github.com/fleetyards/fleetyards/issues/4312)) ([d84b785](https://github.com/fleetyards/fleetyards/commit/d84b785aabcb041f3f5d483155fccab1447542c6))
* **sc-data:** parse EM/IR signatures + ship cross-section ([#4311](https://github.com/fleetyards/fleetyards/issues/4311)) ([15e3818](https://github.com/fleetyards/fleetyards/commit/15e38186a53585ded3371d74a836d7cc6232cf28))
* **ships:** fill item_prices from a daily UEX sync ([#4317](https://github.com/fleetyards/fleetyards/issues/4317)) ([d51f043](https://github.com/fleetyards/fleetyards/commit/d51f043365bc089aa5ebe807cbaf697c01178e5e))
...
* **sim:** power-allocation foundation (parsing + engine core) ([#4266](https://github.com/fleetyards/fleetyards/issues/4266)) ([f28e6e9](https://github.com/fleetyards/fleetyards/commit/f28e6e91859ecffad68b79f37f974fb36ebf0874))
...
* **e2e:** mount cypress-on-rails middleware in test env only ([#4264](https://github.com/fleetyards/fleetyards/issues/4264)) ([c87a6ff](https://github.com/fleetyards/fleetyards/commit/c87a6ffe089c1544d5a322e0d8309a09aa58cf00))
* **frontend:** collapse the mobile list header into two rows ([#4315](https://github.com/fleetyards/fleetyards/issues/4315)) ([34282ad](https://github.com/fleetyards/fleetyards/commit/34282ade065187191eb4fa55217feedc510418dc))
...
* **i18n:** add missing model.poweredByUex translation ([#4329](https://github.com/fleetyards/fleetyards/issues/4329)) ([9289163](https://github.com/fleetyards/fleetyards/commit/92891631da805f260bb06a94e44c6a1146fae28d))
...
* **annotations:** update hardpoint factory annotations ([3d2e951](https://github.com/fleetyards/fleetyards/commit/3d2e9513a002059a1e4bc63769234bb2cd81962a))
* **ci:** unblock the dependency PR queue (libvips, seeds redis, vue-tsc 3.3.9) ([#4290](https://github.com/fleetyards/fleetyards/issues/4290)) ([b1c73e5](https://github.com/fleetyards/fleetyards/commit/b1c73e51e10f8f788ab3de17a4ad78a58b3a8bc9))
...
* **deps-dev:** bump @tanstack/eslint-plugin-query ([#4282](https://github.com/fleetyards/fleetyards/issues/4282)) ([3b7bcc5](https://github.com/fleetyards/fleetyards/commit/3b7bcc5df1ce3eccab84954a3b1516b697d2919f))
...
* **deps-dev:** bump @tanstack/vue-query-devtools from 6.1.36 to 6.1.38 ([#4296](https://github.com/fleetyards/fleetyards/issues/4296)) ([88a8961](https://github.com/fleetyards/fleetyards/commit/88a896172b208560c10f140ebe70c64795f5144d))
...
* **deps-dev:** bump annotaterb from 4.23.0 to 4.24.0 ([#4277](https://github.com/fleetyards/fleetyards/issues/4277)) ([de8a422](https://github.com/fleetyards/fleetyards/commit/de8a422534770a12570fd6c9f4cc2aeec29c6779))
...
* **deps-dev:** bump concurrently from 10.0.3 to 10.0.4 ([#4280](https://github.com/fleetyards/fleetyards/issues/4280)) ([3e92bb8](https://github.com/fleetyards/fleetyards/commit/3e92bb814912369bdff80b53bc41ca1efd91e753))
...
* **deps-dev:** bump cypress-on-rails from 1.20.0 to 1.20.1 ([#4291](https://github.com/fleetyards/fleetyards/issues/4291)) ([8122470](https://github.com/fleetyards/fleetyards/commit/8122470364f5dc2c7427b810d90b8cbbf8338dfc))
...
* **deps-dev:** bump globals from 17.6.0 to 17.9.0 ([#4302](https://github.com/fleetyards/fleetyards/issues/4302)) ([e262813](https://github.com/fleetyards/fleetyards/commit/e262813aaf5af4636f962c0ed63308522797488f))
...
* **deps-dev:** bump knip from 6.17.1 to 6.32.0 ([#4304](https://github.com/fleetyards/fleetyards/issues/4304)) ([10d4c11](https://github.com/fleetyards/fleetyards/commit/10d4c1121d9679bfa17514a589a85208f0b08c9d))
...
* **deps-dev:** bump sass from 1.101.0 to 1.102.0 ([#4298](https://github.com/fleetyards/fleetyards/issues/4298)) ([e64adc8](https://github.com/fleetyards/fleetyards/commit/e64adc8945725964def5945e33568e92f575e924))
...
* **deps-dev:** bump simplecov from 1.0.0 to 1.0.3 ([#4301](https://github.com/fleetyards/fleetyards/issues/4301)) ([985da49](https://github.com/fleetyards/fleetyards/commit/985da49a68cd7d83fe6d714f9df14b1251a43eb4))
...
* **deps-dev:** bump standard from 1.55.0 to 1.56.0 ([#4307](https://github.com/fleetyards/fleetyards/issues/4307)) ([ab53058](https://github.com/fleetyards/fleetyards/commit/ab53058b47a795ea61068f8e0425651fd74750df))
...
* **deps-dev:** bump the playwright group with 2 updates ([#4273](https://github.com/fleetyards/fleetyards/issues/4273)) ([cf65b18](https://github.com/fleetyards/fleetyards/commit/cf65b18d690613af2476b776152d940e743aff88))
...
* **deps-dev:** bump the tailwindcss group with 2 updates ([#4270](https://github.com/fleetyards/fleetyards/issues/4270)) ([bce3a60](https://github.com/fleetyards/fleetyards/commit/bce3a60a556a8be6e2fe602a15178f9b9e9ce23e))
...
* **deps-dev:** bump vite from 8.2.0 to 8.2.1 ([#4294](https://github.com/fleetyards/fleetyards/issues/4294)) ([4d2437e](https://github.com/fleetyards/fleetyards/commit/4d2437eff8bb1fc90ca7e8d6d5881c7e98380e96))
* **deps-dev:** bump vue-component-type-helpers from 3.3.5 to 3.3.9 ([#4284](https://github.com/fleetyards/fleetyards/issues/4284)) ([f1d77d1](https://github.com/fleetyards/fleetyards/commit/f1d77d123c4d061da9173759a1e4630fd60bbf41))
* **deps-dev:** bump vue-tsc from 3.3.5 to 3.3.9 ([#4276](https://github.com/fleetyards/fleetyards/issues/4276)) ([dcbf3fb](https://github.com/fleetyards/fleetyards/commit/dcbf3fb0e4401c931754023b77f3802d451959bf))
...
* **deps:** bump @number-flow/vue from 0.5.0 to 0.5.2 ([#4278](https://github.com/fleetyards/fleetyards/issues/4278)) ([e2d6311](https://github.com/fleetyards/fleetyards/commit/e2d6311fe2f5af2072b9d57d5047ea6ee0ca477c))
* **deps:** bump @rails/actioncable from 8.1.300 to 8.1.301 ([#4287](https://github.com/fleetyards/fleetyards/issues/4287)) ([7d34150](https://github.com/fleetyards/fleetyards/commit/7d3415084349868b864d176bc889a44cf6e5118e))
...
* **deps:** bump @rails/activestorage from 8.1.300 to 8.1.301 ([#4293](https://github.com/fleetyards/fleetyards/issues/4293)) ([5112ad3](https://github.com/fleetyards/fleetyards/commit/5112ad3bd8c9d286a25a0bcd6b07edc0e24a946d))
...
* **deps:** bump @tanstack/vue-query from 5.101.2 to 5.101.4 ([#4285](https://github.com/fleetyards/fleetyards/issues/4285)) ([3417e55](https://github.com/fleetyards/fleetyards/commit/3417e55b690e8772e121361c9e796b736aec3041))
...
* **deps:** bump @vueuse/core from 14.3.0 to 14.4.0 ([#4300](https://github.com/fleetyards/fleetyards/issues/4300)) ([7fd5ded](https://github.com/fleetyards/fleetyards/commit/7fd5ded6af99083ec2d7aeb35c773049e7f5425f))
...
* **deps:** bump appsignal from 4.8.6 to 4.9.1 ([#4275](https://github.com/fleetyards/fleetyards/issues/4275)) ([8c31a9f](https://github.com/fleetyards/fleetyards/commit/8c31a9f36c5594a839561643d1bfe3b1af65359f))
...
* **deps:** bump aws-sdk-s3 from 1.227.0 to 1.229.0 ([#4295](https://github.com/fleetyards/fleetyards/issues/4295)) ([a78132e](https://github.com/fleetyards/fleetyards/commit/a78132e8f41a61960c99cdcf952817b89ac49df8))
* **deps:** bump axios from 1.18.0 to 1.19.0 ([#4286](https://github.com/fleetyards/fleetyards/issues/4286)) ([e11f882](https://github.com/fleetyards/fleetyards/commit/e11f882bceed7dc1bc1665aad6c48361c6f2020a))
...
* **deps:** bump csv from 3.3.5 to 3.3.6 ([#4274](https://github.com/fleetyards/fleetyards/issues/4274)) ([dda1ef0](https://github.com/fleetyards/fleetyards/commit/dda1ef0a152e23c2dc0fe9af1b9a2e23e8ac6f6f))
...
* **deps:** bump docker/login-action from 4.5.2 to 4.6.0 ([#4288](https://github.com/fleetyards/fleetyards/issues/4288)) ([a865da2](https://github.com/fleetyards/fleetyards/commit/a865da20a05f6da11503ebfef8b0b3f21be74729))
* **deps:** bump doorkeeper from 5.9.3 to 5.9.5 ([#4299](https://github.com/fleetyards/fleetyards/issues/4299)) ([3330ff1](https://github.com/fleetyards/fleetyards/commit/3330ff1278b54a792a07a5832340d38b261bbc04))
...
* **deps:** bump doorkeeper-jwt from 0.4.2 to 0.4.3 ([#4283](https://github.com/fleetyards/fleetyards/issues/4283)) ([0110d1e](https://github.com/fleetyards/fleetyards/commit/0110d1e24301eaad9825ed94ff862310bbfe6f96))
...
* **deps:** bump git from 4.4.0 to 5.0.4 ([#4297](https://github.com/fleetyards/fleetyards/issues/4297)) ([8f5f1f2](https://github.com/fleetyards/fleetyards/commit/8f5f1f223d6e06b71ba5005a2867c52200f8b362))
...
* **deps:** bump graphlient from 0.8.0 to 0.9.0 ([#4272](https://github.com/fleetyards/fleetyards/issues/4272)) ([549e28a](https://github.com/fleetyards/fleetyards/commit/549e28aff4acdedcede7b131c7039331e292c474))
* **deps:** bump image_processing from 2.0.2 to 2.0.3 ([#4269](https://github.com/fleetyards/fleetyards/issues/4269)) ([1f243ad](https://github.com/fleetyards/fleetyards/commit/1f243ad9b4708ba42a880a28d2e6b61b88b56517))
...
* **deps:** bump mini_magick from 5.3.1 to 5.3.3 ([#4268](https://github.com/fleetyards/fleetyards/issues/4268)) ([b2ef2a3](https://github.com/fleetyards/fleetyards/commit/b2ef2a392a081d25af633dc874030b96cbca544a))
...
* **deps:** bump oauth2 from 2.0.24 to 2.0.25 ([#4292](https://github.com/fleetyards/fleetyards/issues/4292)) ([d1bf640](https://github.com/fleetyards/fleetyards/commit/d1bf640757b48404d57af5499204b84bf8be0594))
...
* **deps:** bump oj from 3.17.3 to 3.17.5 ([#4271](https://github.com/fleetyards/fleetyards/issues/4271)) ([6e79006](https://github.com/fleetyards/fleetyards/commit/6e790068f6dbd1b8921481796efa47a51d1356c3))
* **deps:** bump pghero from 3.8.0 to 4.0.0 ([#4281](https://github.com/fleetyards/fleetyards/issues/4281)) ([6d61df9](https://github.com/fleetyards/fleetyards/commit/6d61df91db84cb13ff4e3369db1ed6b25c2767d0))
* **deps:** bump qs from 6.15.2 to 6.15.3 ([#4308](https://github.com/fleetyards/fleetyards/issues/4308)) ([434be17](https://github.com/fleetyards/fleetyards/commit/434be17b7dc83e2ca2a8e5c9becc6fa3a1f975de))
...
* **deps:** bump rails from 8.1.3 to 8.1.3.1 ([#4279](https://github.com/fleetyards/fleetyards/issues/4279)) ([f493a90](https://github.com/fleetyards/fleetyards/commit/f493a904d63f7d014d25062cd76348eaf99a9fc4))
...
* **deps:** bump redis-store from 1.11.0 to 1.12.0 ([#4303](https://github.com/fleetyards/fleetyards/issues/4303)) ([82b7334](https://github.com/fleetyards/fleetyards/commit/82b733493d41969157755bdec33e559205601744))
* **deps:** bump reline from 0.6.3 to 0.7.0 ([#4309](https://github.com/fleetyards/fleetyards/issues/4309)) ([7003591](https://github.com/fleetyards/fleetyards/commit/700359117d188465bee9591338c6eb261b7cf124))
...
* **deps:** bump swagger-ui-dist from 5.32.8 to 5.32.12 ([#4310](https://github.com/fleetyards/fleetyards/issues/4310)) ([2c35549](https://github.com/fleetyards/fleetyards/commit/2c355497bc9231c08824c7b3d6176170803e697a))
...
* **deps:** bump vue from 3.5.38 to 3.5.41 ([#4306](https://github.com/fleetyards/fleetyards/issues/4306)) ([6ce1462](https://github.com/fleetyards/fleetyards/commit/6ce146246ce8ac78b5e08d28782c456b4403e2bf))
...
* **deps:** bump with_advisory_lock from 7.5.0 to 7.6.0 ([#4305](https://github.com/fleetyards/fleetyards/issues/4305)) ([4de95d6](https://github.com/fleetyards/fleetyards/commit/4de95d6afb7b560866b3e7eee1aaf7e686720e6e))
...
* **holo-viewer:** bump pinned DRACO decoder to 1.5.7 ([3d00cf6](https://github.com/fleetyards/fleetyards/commit/3d00cf633b1f3ce985fed29a2ac2407ab698c563))
* **holo-viewer:** track camera position for directional light ([f87be16](https://github.com/fleetyards/fleetyards/commit/f87be167770a3ac8d244aa67edbafc32c21ed36e))
* **tooltip:** close tooltip on click and pointerleave ([66835e6](https://github.com/fleetyards/fleetyards/commit/66835e6508e29b3880f4f1496722b90552e2c7c5))


### Chores

* **deps-dev:** bump @tanstack/eslint-plugin-query ([#3906](https://github.com/fleetyards/fleetyards/issues/3906)) ([154a15a](https://github.com/fleetyards/fleetyards/commit/154a15ad8a200e39ba6d2707ba292af9f43f0412))
* **deps-dev:** bump @tanstack/vue-query-devtools from 6.1.28 to 6.1.29 ([#3917](https://github.com/fleetyards/fleetyards/issues/3917)) ([a4fc562](https://github.com/fleetyards/fleetyards/commit/a4fc56293c4bfee5333a08b517b2a8511d33dd2f))
* **deps-dev:** bump @types/node from 25.6.2 to 25.7.0 ([#3901](https://github.com/fleetyards/fleetyards/issues/3901)) ([d41806f](https://github.com/fleetyards/fleetyards/commit/d41806f84da23c2d0c9d4b37c7421e546a66ff3a))
* **deps-dev:** bump @types/node from 25.7.0 to 25.8.0 ([#3934](https://github.com/fleetyards/fleetyards/issues/3934)) ([471e5c4](https://github.com/fleetyards/fleetyards/commit/471e5c462c8a4992e0a5ee562de424ab764eeb74))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([#3919](https://github.com/fleetyards/fleetyards/issues/3919)) ([d197b79](https://github.com/fleetyards/fleetyards/commit/d197b7917d22749ea5e5bdd67c8f11fd422d3fb8))
* **deps-dev:** bump @typescript-eslint/parser from 8.59.2 to 8.59.3 ([#3910](https://github.com/fleetyards/fleetyards/issues/3910)) ([c394f05](https://github.com/fleetyards/fleetyards/commit/c394f054feb0eccf382e70bf8448d5948fb35c9d))
* **deps-dev:** bump knip from 6.12.2 to 6.13.1 ([#3916](https://github.com/fleetyards/fleetyards/issues/3916)) ([bcfd309](https://github.com/fleetyards/fleetyards/commit/bcfd3094f6f55fad96c3ebaeb4762dc014849513))
* **deps-dev:** bump stylelint from 17.11.0 to 17.11.1 ([#3933](https://github.com/fleetyards/fleetyards/issues/3933)) ([8c01fee](https://github.com/fleetyards/fleetyards/commit/8c01fee0bc85bd6c34f7d2dd99e1389babeb706f))
* **deps-dev:** bump stylelint-scss from 7.1.0 to 7.1.1 ([#3903](https://github.com/fleetyards/fleetyards/issues/3903)) ([992fa6f](https://github.com/fleetyards/fleetyards/commit/992fa6f8c9b62ac42ba410566bc2b991c1d99eca))
* **deps-dev:** bump the playwright group across 1 directory with 2 updates ([#3900](https://github.com/fleetyards/fleetyards/issues/3900)) ([3067af5](https://github.com/fleetyards/fleetyards/commit/3067af54f128b59ba850716691b6af51b8da6f47))
* **deps-dev:** bump vite from 8.0.11 to 8.0.12 ([#3908](https://github.com/fleetyards/fleetyards/issues/3908)) ([513dbb4](https://github.com/fleetyards/fleetyards/commit/513dbb46923ffa651f4f808777cb5c5f32290e0e))
* **deps-dev:** bump vite from 8.0.12 to 8.0.13 ([#3935](https://github.com/fleetyards/fleetyards/issues/3935)) ([150774d](https://github.com/fleetyards/fleetyards/commit/150774d67d86aaf58fd23a8d12db7e9ba0c2d4d8))
* **deps-dev:** bump vitest from 4.1.5 to 4.1.6 ([#3909](https://github.com/fleetyards/fleetyards/issues/3909)) ([e886d83](https://github.com/fleetyards/fleetyards/commit/e886d83ed5ae6c001be13e6e4c1d9a1153a1eec8))
* **deps-dev:** bump vue-component-type-helpers from 3.2.8 to 3.2.9 ([#3928](https://github.com/fleetyards/fleetyards/issues/3928)) ([b3ffbbe](https://github.com/fleetyards/fleetyards/commit/b3ffbbeb2900a707d45f43cffb51ca2e0fa8a0c3))
* **deps-dev:** bump vue-tsc from 3.2.8 to 3.2.9 ([#3924](https://github.com/fleetyards/fleetyards/issues/3924)) ([de66088](https://github.com/fleetyards/fleetyards/commit/de660888d56239af980a8131d129f147077f001f))
* **deps:** bump @tanstack/vue-query from 5.100.9 to 5.100.10 ([#3902](https://github.com/fleetyards/fleetyards/issues/3902)) ([a36ac22](https://github.com/fleetyards/fleetyards/commit/a36ac224bcd85589450c33fe8b9823f7ddc143c3))
* **deps:** bump aws-sdk-s3 from 1.221.0 to 1.222.0 ([#3927](https://github.com/fleetyards/fleetyards/issues/3927)) ([104bd36](https://github.com/fleetyards/fleetyards/commit/104bd36cfac08711ce73d5766e9776b973c52522))
* **deps:** bump axios from 1.16.0 to 1.16.1 ([#3926](https://github.com/fleetyards/fleetyards/issues/3926)) ([97c929f](https://github.com/fleetyards/fleetyards/commit/97c929f944661d01b215dd082a901c42e8449268))
* **deps:** bump flipper from 1.4.1 to 1.4.2 ([#3904](https://github.com/fleetyards/fleetyards/issues/3904)) ([20c56b6](https://github.com/fleetyards/fleetyards/commit/20c56b6915b10d17e4746b69662f2b47769c1cd8))
* **deps:** bump flipper-active_record from 1.4.1 to 1.4.2 ([#3907](https://github.com/fleetyards/fleetyards/issues/3907)) ([be09063](https://github.com/fleetyards/fleetyards/commit/be09063624388aff68579ecfbf27e4ab4e4cbfee))
* **deps:** bump maintenance_tasks from 2.15.0 to 2.16.0 ([#3932](https://github.com/fleetyards/fleetyards/issues/3932)) ([a034a3c](https://github.com/fleetyards/fleetyards/commit/a034a3cfd5fb04df480b1043a24344ae1d3a7d5f))
* **deps:** bump sidekiq from 8.1.4 to 8.1.5 ([#3923](https://github.com/fleetyards/fleetyards/issues/3923)) ([ae43228](https://github.com/fleetyards/fleetyards/commit/ae432280d93d1b431d7efeb03ac031dc7fc38357))
* **deps:** bump swagger-ui-dist from 5.32.5 to 5.32.6 ([#3915](https://github.com/fleetyards/fleetyards/issues/3915)) ([61a5c61](https://github.com/fleetyards/fleetyards/commit/61a5c61f8615759748531cfb3f4151efcd1c5a94))
* **deps:** bump vue-router from 5.0.6 to 5.0.7 ([#3929](https://github.com/fleetyards/fleetyards/issues/3929)) ([8ad0e41](https://github.com/fleetyards/fleetyards/commit/8ad0e4111148abd211526ee30a8fcc1542b9fe9b))
* update SC data version to 4.8.0-live.11825000 ([e770ed8](https://github.com/fleetyards/fleetyards/commit/e770ed8625133d012390d2f9911e92ad20110fe7))
* update SC data version to 4.8.0-live.11825000 ([e0735ee](https://github.com/fleetyards/fleetyards/commit/e0735eee998732878cb3aa31fa47cb1fadbef600))
