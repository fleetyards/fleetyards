...
export const getItemPricesQueryOptions = <
...
>(
  ...
  const queryOptions = getItemPricesQueryOptions(params, options);
...
export const getItemPriceQueryOptions = <
...
>(
  ...
  return {
    ...
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof itemPrice>>, TError, TData>;
};
...
>(
  ...
  const queryOptions = getItemPriceQueryOptions(id, options);
