...
>(
  ...
  const queryOptions = getImportsQueryOptions(params, options);
...
export const getImportQueryOptions = <
...
>(
  ...
  return {
    ...
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof _import>>, TError, TData>;
};
...
>(
  ...
  const queryOptions = getImportQueryOptions(id, options);
