export default {
  ...
  signup: {
    success: '<b>Benvenuto su FleetYards.net!</b> Il tuo account è stato creato. <br>Riceverai un\'email di conferma per attivare il tuo account.',
    invalid: 'Si prega di risolvere gli errori prima che il tuo account possa essere creato.',
    failure: 'Impossibile creare un nuovo account. Riprova più tardi.'
  },
  accountConfirm: {
    success: 'Il tuo account è stato confermato con successo.<br>Ora puoi effettuare il login.',
    failure: 'Non é stato possibile confermare il tuo account.'
  },
  requestPasswordChange: { success: 'Se la tua email esiste nel nostro database, entro qualche minuto riceverai un messaggio email contenente un link per il ripristino della password.' },
  changePassword: {
  ...
  avatarUpload: {
    ...
    invalidExtension: 'L\'immagine che hai fornito ha un formato non valido. I formati supportati sono: %{extensions}.'
  },
  hangarImport: {
    success: 'Importazione completata',
    partialSuccess: 'Importazione parzialmente completata.<br><br>Navi non trovate: <br>%{missing}',
    failure: 'Importazione fallita',
    invalidExtension: 'L\'import che hai fornito ha un formato non valido. I formati supportati sono: %{extensions}.'
  },
  hangarExport: { failure: 'Esportazione fallita. Per favore riprova più tardi.' },
  vehicle: {
    add: { success: 'La tua nuova <b>%{model}</b> sarà consegnata al tuo <a href="/hangar">Hangar</a>' },
    addToWishlist: { success: 'Your new <b>%{model}</b> was added to your <a href="/hangar/wishlist">Wishlist</a>' },
    resetIngame: {
      moveToWishlist: {
  ...
  error: {
    ...
    hangar: { accountRequired: 'You need to <a href="/sign-up/">Sign up</a> or <a href="/login/">Login</a> to add Ships to your Hangar.<br>Get more Information <a href="/hangar/preview/">here</a>' },
    commodityPrice: { accountRequired: 'You need to <a href="/sign-up/">Sign up</a> or <a href="/login/">Login</a> to submit Prices.' },
    default: '<b>Something wrong happened.</b> <br>Have you tried turning it off and on again?'
  },
  account: {
    destroy: {
      success: '<b>Il tuo account è stato distrutto.</b> <br>É un peccato vederti andare :\'(',
  ...
  holoViewer: { modelLoader: { failure: 'Non è stato possibile caricare il modello 3D richiesto! Riprova più tardi.' } },
  confirm: {
    vehicle: { destroy: 'Sei sicuro di voler rimuovere questa Nave dall\'Hangar?' },
    hangarGroup: { destroy: 'Sei sicuro di voler rimuovere questo Gruppo dall\'Hangar?' },
    hangar: {
      import: 'Le navi importate saranno aggiunte al tuo Hangar senza corrispondere alle navi già presenti.<br><br>Formati supportati sono: Fleetyards Export, Starship42 o HangarXplor.<br><br>Vuoi continuare?',
      destroySelected: 'Sei sicuro di voler rimuovere tutte le navi selezionate dall\'Hangar? Questa azione non può essere annullata.',
      destroyAll: 'Sei sicuro di voler rimuovere tutte le navi dall\'Hangar? Questa azione non può essere annullata.'
    },
    wishlist: { destroyAll: 'Are you sure you want to remove all Ships from you Wishlist? This Action can\'t be reverted.' },
    tradeRoutes: { reset: 'Are you sure you want to reset all commodity prices?' },
    account: { destroy: 'Sei sicuro di voler eliminare il tuo account? Questa azione non potrà essere annullata.' },
    commodityPrice: { destroy: 'Sei sicuro di voler eliminare questo prezzo? Questa azione non potrà essere annullata.' },
    shopCommodity: { destroy: 'Are you sure you want to destroy this Commodity? This Action can\'t be reverted.' },
    fleet: {
      leave: 'Sei sicuro di voler lasciare questa Flotta? Questa azione non potrà essere annullata.',
      destroy: 'Sei sicuro di voler eliminare la tua Flotta? Questa azione non potrà essere annullata.',
      members: { destroy: 'Sei sicuro di voler rimuovere questo membro?' },
      invites: { decline: 'Sei sicuro di voler rifiutare questo invito? Questa azione non potrà essere annullata.' }
    },
    modal: { dirty: 'Sono presenti modifiche non salvate che andranno perse.' },
    twoFactor: { generateBackupCodes: 'Sei sicuro di voler generare nuovi Codici di Backup per la 2FA?' }
  },
  syncExtension: {
    started: 'Syncing your Hangar...',
    success: 'Your Hangar has been synced.',
    failure: 'Your Hangar could not be synced.',
    notLoggedIn: 'You need to be logged in on <a href="https://robertsspaceindustries.com" target="_blank">https://robertsspaceindustries.com</a> to sync your Hangar.'
  }
};