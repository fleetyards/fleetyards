...
json.sold_at do
  json.array! equipment.sold_at, partial: "api/v2/shop_commodities/base", as: :shop_commodity
end
json.bought_at do
  json.array! equipment.bought_at, partial: "api/v2/shop_commodities/base", as: :shop_commodity
end
json.listed_at do
  json.array! equipment.listed_at, partial: "api/v2/shop_commodities/base", as: :shop_commodity
end
json.manufacturer do
  json.null! if equipment.manufacturer.blank?
  json.partial! "api/v2/manufacturers/base", manufacturer: equipment.manufacturer if equipment.manufacturer.present?
end
