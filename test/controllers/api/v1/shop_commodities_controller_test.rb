    ...
    class ShopCommoditiesControllerTest < ActionController::TestCase
      ...
      let(:index_result) do
        [{
          ...
          'storeImageStore' => explorer.commodity_item.store_image.store.url,
          ...
          'shop' => {
            ...
            'storeImageStore' => explorer.shop.store_image.store.url,
          ...
          'storeImageStore' => andromeda.commodity_item.store_image.store.url,
          ...
          'shop' => {
            ...
            'storeImageStore' => andromeda.shop.store_image.store.url,
