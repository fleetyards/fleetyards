...
new_babbage.update!(celestial_object: microtech, station_type: :spaceport, location: 'New Babbage', store_image: Rails.root.join('db/seeds/images/stanton/microtech/new-babbage.jpg').open, hidden: false)
