...
// The manager select asks the fleet for its members on mount, which is not what
// this is about.
vi.mock("@/shared/components/base/Select/index.vue", () => ({
  default: { name: "BaseSelect", render: () => null },
}));
 ...
 */
describe("FleetLogisticsInventoryModal preview", () => {
