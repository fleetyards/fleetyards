...
export const useComponentsQueryOptions = <TData = Awaited<ReturnType<typeof components>>, TError = ErrorType<unknown>>(params?: MaybeRef<ComponentsParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof components>>, TError, TData>>, }
) => {
...
export function useComponents<TData = Awaited<ReturnType<typeof components>>, TError = ErrorType<unknown>>(
