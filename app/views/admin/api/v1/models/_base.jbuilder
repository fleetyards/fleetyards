...
json.media do
  ...
  json.rsi_store_image do
    json.partial! "api/v1/shared/view_image", record: model, attr: :new_rsi_store_image, old_attr: :rsi_store_image, width: model.rsi_store_image_width, height: model.rsi_store_image_height
  end
  json.top_view do
