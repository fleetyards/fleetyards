...
class Admin::Api::V1::ModelsTest < ActionDispatch::IntegrationTest
  ...
  api_path "/models" do
    post("Create Model") do
      ...
      request_body required: true, schema: ::Admin::V1::Schemas::Inputs::ModelCreateInput

      response(200, "successful") do
        schema ::Admin::V1::Schemas::Models::ModelExtended
      end
    ...
    get("Models list") do
      ...
      parameter name: "q", in: :query,
        schema: ::Admin::V1::Schemas::Queries::ModelQuery,
        style: :deepObject,
        explode: true,
        required: false

      response(200, "successful") do
        schema ::Admin::V1::Schemas::Models::Models
      end
  ...
  api_path "/models/{id}" do
    ...
    put("Update Model") do
      ...
      request_body required: true, schema: ::Admin::V1::Schemas::Inputs::ModelUpdateInput
