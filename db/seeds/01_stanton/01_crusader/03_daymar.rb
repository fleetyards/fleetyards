...
corvolex_shipping.update!(celestial_object: daymar, station_type: 'cargo-station', location: 'Orbit', store_image: Rails.root.join('db/seeds/images/stanton/crusader/daymar/covalex.jpg').open, hidden: false)

shubin = Station.find_or_initialize_by(name: 'Shubin Mining Facility SCD-1')
shubin.update!(celestial_object: daymar, station_type: :outpost, location: 'Daymar', store_image: Rails.root.join('db/seeds/images/stanton/crusader/daymar/shubin.jpg').open, hidden: false)
...
bountiful_harvest.update!(celestial_object: daymar, station_type: :outpost, location: 'Daymar', store_image: Rails.root.join('db/seeds/images/stanton/crusader/daymar/bountiful.jpg').open, hidden: false)
...
eager_flats.update!(celestial_object: daymar, station_type: :aid_shelter, location: 'Daymar', store_image: Rails.root.join('db/seeds/images/stanton/crusader/daymar/eager.jpg').open, hidden: false)

wolf_point = Station.find_or_initialize_by(name: 'Wolf Point Aid Shelter')
wolf_point.update!(celestial_object: daymar, station_type: :aid_shelter, location: 'Daymar', store_image: Rails.root.join('db/seeds/images/stanton/crusader/daymar/wolfpoint.jpg').open, hidden: false)

tamdon_plains = Station.find_or_initialize_by(name: 'Tamdon Plains Aid Shelter')
tamdon_plains.update!(celestial_object: daymar, station_type: :aid_shelter, location: 'Daymar', store_image: Rails.root.join('db/seeds/images/stanton/crusader/daymar/tamdon.jpg').open, hidden: false)
