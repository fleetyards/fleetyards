export default {
  ...
  requestPasswordChange: { success: 'If your email address exists in our database, you will receive a password recovery link at your email address in a few minutes.' },
  changePassword: {
  ...
  avatarUpload: {
    ...
    invalidExtension: 'The Picture you provided has an invalid Format. Supported Formats are: %{extensions}.'
  },
  hangarImport: {
    success: 'Import completed',
    partialSuccess: 'Import partially completed.<br><br>Not found Ships: <br>%{missing}',
    failure: 'Import failed',
    invalidExtension: 'The Import you provided has an invalid Format. Supported Formats are: %{extensions}.'
  },
  hangarExport: { failure: 'Export failed, Please try again later.' },
  vehicle: {
    add: { success: 'Your new <b>%{model}</b> will be delivered to your <a href="/hangar">Hangar</a>' },
  ...
  commodityPrice: { create: { success: 'Thank you for your price submission.' } },
  fleet: {
    create: {
  ...
  holoViewer: { modelLoader: { failure: 'We could not load the requested 3D model! Please try again later.' } },
  confirm: {
    vehicle: { destroy: 'Are you sure you want to remove this Ship from you Hangar?' },
    hangarGroup: { destroy: 'Are you sure you want to remove this Group from you Hangar?' },
    hangar: {
      import: 'Imported ships will be added to your Hangar without matching to exisiting Ships.<br><br>Supported Formats are: Fleetyards Export, Starship42 or HangarXplor.<br><br>Do you want to continue?',
      destroySelected: 'Are you sure you want to remove all Selected Ships from you Hangar? This Action can\'t be reverted.',
      destroyAll: 'Are you sure you want to remove all Ships from you Hangar? This Action can\'t be reverted.'
    },
    ...
    account: { destroy: 'Are you sure you want to destroy your Account? This Action can\'t be reverted.' },
    commodityPrice: { destroy: 'Are you sure you want to destroy this Price? This Action can\'t be reverted.' },
    ...
    fleet: {
      ...
      invites: { decline: 'Are you sure you want to decline this Invite? This Action can\'t be reverted.' }
    },
    modal: { dirty: 'You have unsaved changes that will be lost.' },
    twoFactor: { generateBackupCodes: 'Are you sure you want to regenerate your Two-factor Backup Codes?' }
  },
  syncExtension: {
