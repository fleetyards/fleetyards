...
module Admin
  class ModelModulesController < ::Admin::ApplicationController
    ...
    private def model_module_params
      @model_module_params ||= params.require(:model_module).permit(
        :name, :hidden, :active, :store_image, :store_image_cache, :remove_store_image, :manufacturer_id,
    ...
    private def save_filters
      session[:model_modules_filters] = params.permit(q: [
