  ...
  module V1
    class FleetContractsController < ::Api::BaseController
      ...
      def index
        ...
        # The work in hand rather than the history: an expired contract counts
        # only while a delivery against it still waits for an answer.
        scope = scope.without_settled_expiry if params[:in_hand].to_s == "true"
