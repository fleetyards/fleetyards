...
export class FleetsCollection extends BaseCollection {
  ...
  async create(form, _refetch = false) {
  ...
  async findModelsByClassificationBySlug(slug) {
  ...
  async findModelsBySizeBySlug(slug) {
  ...
  async findModelsByManufacturerBySlug(slug) {
  ...
  async findModelsByProductionStatusBySlug(slug) {
