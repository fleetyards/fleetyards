...
RSpec.describe "api/v1/fleets/mission_teams", type: :openapi, openapi_schema_name: :"v1/schema" do
  ...
  let(:id) { team.id }
  let(:request_body) { {title: "Renamed Team"} }
  ...
  path "/fleets/{fleetSlug}/missions/{missionSlug}/teams/{id}" do
    ...
    put("Update Mission Team") do
      ...
      request_body schema: {"$ref": "#/components/schemas/MissionTeamUpdateInput"}, required: true
      ...
      response(200, "successful") do
        ...
        run_test! do |response|
          ...
          expect(data["title"]).to eq("Renamed Team")
        end
      end
