...
CarrierWave.configure do |config|
  if Rails.env.test?
    ...
    # config.asset_host = (Rails.application.credentials.carrierwave_cloud_cdn_endpoint || Rails.configuration.app.frontend_endpoint)
    config.asset_host = Rails.configuration.app.frontend_endpoint
  else
    config.storage :file
    config.asset_host = Rails.configuration.app.frontend_endpoint
  end
