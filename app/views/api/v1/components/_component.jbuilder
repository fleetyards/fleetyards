...
# served once until this moves. The locale is in it because `itemClassLabel` is
# translated, and a fragment filled in one language was served to every reader.
json.cache! [
  "v3", I18n.locale, component, ::ScData::Source.current, component.item_prices_cache_key,
