...
class Api::V1::PublicFleetsStatsModelsBySizeTest < ActionDispatch::IntegrationTest
  include OpenapiRuby::Adapters::Minitest::DSL

  openapi_schema :"v1/schema"

  api_path "/public/fleets/{fleetSlug}/stats/models-by-size" do
  ...
  test "GET /public/fleets/:fleetSlug/stats/models-by-size returns chart data" do
  ...
  test "GET /public/fleets/:fleetSlug/stats/models-by-size returns 404 for non-public stats" do
