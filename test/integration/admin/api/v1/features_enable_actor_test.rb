...
class Admin::Api::V1::FeaturesEnableActorTest < ActionDispatch::IntegrationTest
  include OpenapiRuby::Adapters::Minitest::DSL

  openapi_schema :"admin/v1/schema"

  api_path "/features/{id}/enable-actor" do
    parameter name: "id", in: :path, schema: {type: :string}, description: "Feature name", required: true

    put("Enable Feature for Actor") do
      operationId "enableAdminFeatureActor"
      tags "Features"
