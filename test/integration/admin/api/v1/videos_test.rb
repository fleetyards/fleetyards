...
class Admin::Api::V1::VideosTest < ActionDispatch::IntegrationTest
  ...
  api_path "/videos" do
    post("Create new Video") do
      ...
      request_body required: true, schema: ::Admin::V1::Schemas::Inputs::VideoInput

      response(201, "successful") do
        schema ::Admin::V1::Schemas::Video
      end
    ...
    get("Videos list") do
      ...
      parameter name: "q", in: :query,
        schema: ::Admin::V1::Schemas::Queries::VideoQuery,
        style: :deepObject,
        explode: true,
        required: false

      response(200, "successful") do
        schema ::Admin::V1::Schemas::Videos
      end
