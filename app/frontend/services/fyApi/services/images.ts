...
>(
  ...
  const queryOptions = getImagesQueryOptions(params, options);
...
export const getImagesRandomQueryOptions = <
...
>(
  ...
  const queryOptions = getImagesRandomQueryOptions(params, options);
