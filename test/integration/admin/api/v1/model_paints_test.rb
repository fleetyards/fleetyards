...
class Admin::Api::V1::ModelPaintsTest < ActionDispatch::IntegrationTest
  ...
  api_path "/model-paints" do
    post("Create Model Paint") do
      ...
      request_body required: true, schema: ::Admin::V1::Schemas::Inputs::ModelPaintInput

      response(200, "successful") do
        schema ::Admin::V1::Schemas::Models::Paints::ModelPaint
      end
    ...
    get("Paints list") do
      ...
      parameter name: "q", in: :query,
        schema: ::Admin::V1::Schemas::Queries::ModelPaintQuery,
        style: :deepObject,
        explode: true,
        required: false

      response(200, "successful") do
        schema ::Admin::V1::Schemas::Models::Paints::ModelPaints
      end
  ...
  test "PUT /model-paints/:id clears the store image" do
    paint = create(:model_paint)
    ...
    assert_api_response :put, 200, path_params: {id: paint.id}, body: {storeImage: nil}

    assert_not_predicate paint.reload.store_image, :attached?
  end
