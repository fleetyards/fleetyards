...
export const getPublicUserQueryOptions = <
...
>(
  ...
  return {
    ...
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof publicUser>>, TError, TData>;
};
...
>(
  ...
  const queryOptions = getPublicUserQueryOptions(username, options);
