...
class Admin::Api::V1::FleetMembersShowTest < ActionDispatch::IntegrationTest
  ...
  test "GET /members/:id returns the fleet member" do
    sign_in @user

    assert_api_response :get, 200, path_params: {fleet_id: @fleet.id, id: @membership.id}
  end

  test "GET /members/:id returns 404 for missing membership" do
    sign_in @user
  ...
  test "GET /members/:id returns 403 for admin without access" do
