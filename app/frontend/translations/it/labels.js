export default {
  ...
  blank: {
    ...
    userShips: 'Il tuo Hangar è attualmente vuoto. Per aggiungere navi / veicoli al tuo Hangar fare clic sulla seguente icona su qualsiasi nave nel database:'
  },
  user: {
    rsiHandle: 'Handle',
    avatar: 'Avatar',
    ...
    publicHangarLoaners: 'Mostra suggerimento Navi di Cortesia su Hangar Pubblico',
  ...
  account: { destroyInfo: 'Se si desidera eliminare il tuo account e rimuovere tutte le informazioni da Fleetyards,nett e i suoi servizi fare clic sul pulsante qui sotto. Sii consapevole che questa è un\'azione permanente e non può essere annullata.' },
  filters: {
    shops: {
      name: 'Nome',
      type: 'Tipo',
