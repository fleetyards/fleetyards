...
export const usePublicHangarEmbedQueryOptions = <
...
>(
  ...
  const queryOptions = usePublicHangarEmbedQueryOptions(params, options);
...
export const usePublicHangarQueryOptions = <
...
>(
  ...
  const queryOptions = usePublicHangarQueryOptions(username, params, options);
