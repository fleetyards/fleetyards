    ...
    class StarsystemsControllerTest < ActionController::TestCase
      ...
      let(:index_result) do
        [{
          ...
          'storeImageStore' => oberon.store_image.store.url,
          ...
          'storeImageStore' => stanton.store_image.store.url,
          ...
          'celestialObjects' => [{
            ...
            'storeImageStore' => stanton.celestial_objects.first.store_image.store.url,
            ...
            'storeImageStore' => stanton.celestial_objects.last.store_image.store.url,
