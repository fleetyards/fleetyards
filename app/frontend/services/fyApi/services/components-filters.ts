...
export const getComponentItemTypesFiltersQueryOptions = <
...
>(options?: {
  ...
  const queryOptions = getComponentItemTypesFiltersQueryOptions(options);
...
export const getComponentClassesFiltersQueryOptions = <
...
>(options?: {
  ...
  const queryOptions = getComponentClassesFiltersQueryOptions(options);
