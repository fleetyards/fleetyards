...
json.sold_at do
  json.array! model.sold_at, partial: "api/v2/shop_commodities/base", as: :shop_commodity
end
json.bought_at do
  json.array! model.bought_at, partial: "api/v2/shop_commodities/base", as: :shop_commodity
end
json.listed_at do
  json.array! model.listed_at, partial: "api/v2/shop_commodities/base", as: :shop_commodity
end
json.rental_at do
  json.array! model.rental_at, partial: "api/v2/shop_commodities/base", as: :shop_commodity
end
json.manufacturer do
  json.null! if model.manufacturer.blank?
  json.partial! "api/v2/manufacturers/base", manufacturer: model.manufacturer if model.manufacturer.present?
end
json.loaners do
  json.array! model.loaners, partial: "api/v2/models/loaner", as: :loaner
end
