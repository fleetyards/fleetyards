...
const addToWishlistBulk = async () => {
  ...
  await vehiclesCollection.addToWishlistBulk(props.selected);
...
const addToHangarBulk = async () => {
  ...
  await vehiclesCollection.addToHangarBulk(props.selected);
...
const hideFromPublicHangar = async () => {
  ...
  await vehiclesCollection.hideFromPublicHangar(props.selected);
...
const showOnPublicHangar = async () => {
  ...
  await vehiclesCollection.showOnPublicHangar(props.selected);
...
const destroyBulk = async () => {
  ...
  displayConfirm({
    ...
    onConfirm: async () => {
      await vehiclesCollection.destroyBulk(props.selected);
