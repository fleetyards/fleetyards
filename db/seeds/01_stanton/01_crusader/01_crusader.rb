...
r_n_r_cru_l3.update!(celestial_object: crusader, station_type: :rest_stop, location: 'CRU-L3', hidden: false)
...
r_n_r_cru_l4.update!(celestial_object: crusader, station_type: :rest_stop, location: 'CRU-L4', hidden: false)
...
r_n_r_cru_l5.update!(celestial_object: crusader, station_type: :rest_stop, location: 'CRU-L5', hidden: false)
