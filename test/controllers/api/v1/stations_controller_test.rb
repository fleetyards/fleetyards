    ...
    class StationsControllerTest < ActionController::TestCase
      ...
      let(:index_result) do
        [{
          ...
          'storeImageStore' => arccorp_daymar.store_image.store.url,
          ...
          'celestialObject' => {
            ...
            'storeImageStore' => daymar.store_image.store.url,
            ...
            'parent' => {
              ...
              'storeImageStore' => crusader.store_image.store.url,
              ...
              'starsystem' => {
                ...
                'storeImageStore' => crusader.starsystem.store_image.store.url,
          ...
          'storeImageStore' => arccorp_yela.store_image.store.url,
          ...
          'celestialObject' => {
            ...
            'storeImageStore' => yela.store_image.store.url,
          ...
          'storeImageStore' => corvolex.store_image.store.url,
          ...
          'storeImageStore' => portolisar.store_image.store.url,
          ...
          'celestialObject' => {
            ...
            'storeImageStore' => portolisar.celestial_object.store_image.store.url,
            ...
            'starsystem' => {
              ...
              'storeImageStore' => portolisar.starsystem.store_image.store.url,
      ...
      let(:show_result) do
        {
          ...
          'shops' => [{
            ...
            'storeImageStore' => portolisar_admin.store_image.store.url,
            ...
            'storeImageStore' => portolisar_dumpers.store_image.store.url,
            ...
            'storeImageStore' => portolisar_new_deal.store_image.store.url,
