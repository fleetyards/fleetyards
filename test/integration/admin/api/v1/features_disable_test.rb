...
class Admin::Api::V1::FeaturesDisableTest < ActionDispatch::IntegrationTest
  ...
  api_path "/features/{id}/disable" do
  ...
  test "PUT /features/:id/disable disables the feature" do
    sign_in @user

    assert_api_response :put, 200, path_params: {id: "TestFeature"}
  end

  test "PUT /features/:id/disable returns 404 for unknown feature" do
    sign_in @user

    assert_api_response :put, 404, path_params: {id: "NonExistentFeature"}
  end

  test "PUT /features/:id/disable returns 401 when not signed in" do
    assert_api_response :put, 401, path_params: {id: "TestFeature"}
  end

  test "PUT /features/:id/disable returns 403 for admin without access" do
