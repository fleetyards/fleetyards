export default {
  ...
  info: {
    ...
    googleFonts: {
      title: 'Google Fonts',
      text: 'This is a collection of fonts for commercial and personal use.',
      why: 'Providing fonts',
      data: [
        'IP address',
        'Referrer URL',
    ...
    ahoy: {
      ...
      text: 'This is a web analytics tool for the ruby on rails framework',
      why: 'Analytics',
      data: [
      ...
      location: 'Germany and Finnland (Server location)',
    },
  },
  save: 'Save settings',
  accept: 'Accept',
  editSettings: 'Configure settings',
}
