...
class Admin::Api::V1::ComponentsTest < ActionDispatch::IntegrationTest
  ...
  api_path "/components" do
    post("Create Component") do
      ...
      request_body required: true, schema: ::Admin::V1::Schemas::Inputs::ComponentInput

      response(200, "successful") do
        schema ::Admin::V1::Schemas::Component
      end
    ...
    get("Components list") do
      ...
      parameter name: "q", in: :query,
        schema: ::Admin::V1::Schemas::Queries::ComponentQuery,
        style: :deepObject,
        explode: true,
        required: false
