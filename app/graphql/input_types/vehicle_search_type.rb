...
InputTypes::VehicleSearchType = ::GraphQL::InputObjectType.define do
  ...
  argument :purchasedEq, types.String, as: :purchased_eq
  argument :modelNameOrDescriptionCont, types.String, as: :ship_name_or_ship_description_cont
  ...
  argument :modelRoleIn, types[!types.String], as: :ship_ship_role_slug_in
