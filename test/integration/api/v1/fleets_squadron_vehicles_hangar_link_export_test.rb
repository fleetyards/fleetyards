...
class Api::V1::FleetsSquadronVehiclesHangarLinkExportTest < ActionDispatch::IntegrationTest
  include OpenapiRuby::Adapters::Minitest::DSL

  openapi_schema :"v1/schema"

  api_path "/fleets/{fleetSlug}/squadrons/{fleetSquadronSlug}/vehicles/export/hangar-link" do
    parameter name: "fleetSlug", in: :path, schema: {type: :string}, description: "Fleet slug"
    parameter name: "fleetSquadronSlug", in: :path, schema: {type: :string}, description: "Squadron slug"

    get("Fleet Squadron Vehicles Hangar Link Export") do
      operationId "fleetSquadronVehiclesHangarLinkExport"
      tags "FleetSquadrons"
  ...
  test "GET squadron hangar-link export returns only the squadron members' ships" do
    sign_in @admin
  ...
  test "GET squadron hangar-link export returns 404 for an unknown squadron" do
    sign_in @admin

    assert_api_response :get, 404, path_params: {fleetSlug: @fleet.slug, fleetSquadronSlug: "no-such-wing"}
  end

  test "GET squadron hangar-link export returns 401 when not signed in" do
