...
RSpec.describe "api/v1/users", type: :request, swagger_doc: "v1.yaml" do
  before do
  ...
  path "/users/current-account" do
    put("update_account user") do
      tags "CurrentUser"
      consumes "application/json"
      produces "application/json"
