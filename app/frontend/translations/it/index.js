export default {
  ...
  meta: {
    description:
      "FleetYards.net, il tuo database per tutte le informazioni relative alle navi di “Star Citizen“.",
    keywords:
      "Star Citizen, Astronavi, Navi, Caccia, Database, Squadron, 42, Star, Citizen, Italiano, Chris, Roberts, Online, Gioco, Spazio, Simulazione",
  },
  station: {
    type: "Tipo",
    location: "Posizione",
