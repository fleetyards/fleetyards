    ...
    class ShopsControllerTest < ActionController::TestCase
      ...
      let(:show_result) do
        {
          ...
          'storeImageStore' => new_deal.store_image.store.url,
      ...
      let(:index_result) do
        [{
          ...
          'storeImageStore' => admin_daymar.store_image.store.url,
          ...
          'storeImageStore' => admin_yela.store_image.store.url,
          ...
          'storeImageStore' => admin_olisar.store_image.store.url,
          ...
          'storeImageStore' => dumpers.store_image.store.url,
