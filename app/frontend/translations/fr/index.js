export default {
  ...
  meta: {
    description:
      "FleetYards.net, votre base de données pour toutes les informations relatives aux vaisseaux de « Star Citizen ».",
    keywords:
      "Star Citizen, vaisseaux spatiaux, vaisseaux, Fighter, Database, Squadron, 42, Star, Citizen, Français, Chris, Roberts, Online, Game, Espace, Simulation",
  },
  station: {
    type: "Type",
    location: "Lieu",
