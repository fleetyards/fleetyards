...
json.model do
  json.partial! 'api/v2/models/minimal', model: vehicle.model if vehicle.model.present?
end
json.model nil if vehicle.model.blank?
json.paint do
  json.partial! 'api/v2/model_paints/minimal', model_paint: vehicle.model_paint if vehicle.model_paint.present?
end
json.paint nil if vehicle.model_paint.blank?
json.upgrade do
  json.partial! 'api/v2/model_upgrades/minimal', model_upgrade: vehicle.model_upgrades.first if vehicle.model_upgrades.present?
end
json.upgrade nil if vehicle.model_upgrades.blank?
json.hangar_group_ids vehicle.hangar_group_ids
json.hangar_groups do
  json.array! vehicle.hangar_groups, partial: 'api/v2/hangar/groups/base', as: :group
end
json.model_module_ids vehicle.model_module_ids
json.model_upgrade_ids vehicle.model_upgrade_ids
json.module_package do
  json.partial! 'api/v2/model_module_packages/minimal', module_package: vehicle.module_package if vehicle.module_package.present?
end
