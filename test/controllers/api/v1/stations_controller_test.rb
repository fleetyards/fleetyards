    ...
    class StationsControllerTest < ActionController::TestCase
      ...
      let(:index_result) do
        [{
          ...
          'habitations' => [],
          'hasImages' => false,
          'createdAt' => arccorp_yela.created_at.to_time.iso8601,
          'updatedAt' => arccorp_yela.updated_at.to_time.iso8601
        }, {
          'name' => 'ArcCorp',
          'slug' => 'arccorp',
          'location' => nil,
          ...
          'habitations' => [],
          'hasImages' => false,
          'createdAt' => arccorp_daymar.created_at.to_time.iso8601,
          'updatedAt' => arccorp_daymar.updated_at.to_time.iso8601
        }, {
