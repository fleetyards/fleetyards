<script lang="ts">
export default {
  name: "ComponentItemTypeFilterGroup",
};
</script>

<script lang="ts" setup>
import {
  componentItemTypes as fetchComponentItemTypes,
  type FilterOption,
...
const fetch = async (_params: FilterGroupParams<FilterOption>) => {
  return fetchComponentItemTypes();
};
</script>
...
<template>
  <FilterGroup
    ...
    :label="t('labels.filters.components.itemType')"
    :query-fn="fetch"
    :name="name"
    :multiple="multiple"
    :no-label="noLabel"
