...
class Api::V1::FleetsMembersDeclineRequestTest < ActionDispatch::IntegrationTest
  include OpenapiRuby::Adapters::Minitest::DSL

  openapi_schema :"v1/schema"

  api_path "/fleets/{fleetSlug}/members/{username}/decline" do
  ...
  test "PUT /fleets/:slug/members/:username/decline declines the request" do
    sign_in @admin

    assert_api_response :put, 200, path_params: {fleetSlug: @fleet.slug, username: @applicant.username}, body: {}
  end

  test "PUT /fleets/:slug/members/:username/decline returns 404 for unknown member" do
    sign_in @admin

    assert_api_response :put, 404, path_params: {fleetSlug: @fleet.slug, username: "unknown"}, body: {}
  end

  test "PUT /fleets/:slug/members/:username/decline returns 403 for non-admin member" do
    sign_in @member

    assert_api_response :put, 403, path_params: {fleetSlug: @fleet.slug, username: @applicant.username}, body: {}
  end

  test "PUT /fleets/:slug/members/:username/decline returns 401 when not signed in" do
    assert_api_response :put, 401, path_params: {fleetSlug: @fleet.slug, username: @applicant.username}, body: {}
  end

  test "PUT /fleets/:slug/members/:username/decline with OAuth bearer token" do
