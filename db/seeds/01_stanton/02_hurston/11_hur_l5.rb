...
hur_l5.update!(
  ...
  location: 'HUR-L5',
  store_image: Rails.root.join('db/seeds/images/stanton/hurston/hur-l5/hur-l5-a.jpg').open,
  hidden: hidden
)
...
admin_office.update!(
  shop_type: :admin,
  store_image: Rails.root.join('db/seeds/images/stanton/hurston/hur-l5/admin.jpg').open,
  buying: true,
  selling: true,
  hidden: hidden
)
...
live_fire_weapons.update!(
  shop_type: :weapons,
  store_image: Rails.root.join('db/seeds/images/stanton/hurston/hur-l5/weapons.jpg').open,
  selling: true,
  hidden: hidden
)
...
casaba.update!(
  shop_type: :clothing,
  store_image: Rails.root.join('db/seeds/images/stanton/hurston/hur-l5/casaba.jpg').open,
  selling: true,
  hidden: hidden
)
...
platinum_bay.update!(
  ...
  store_image: Rails.root.join('db/seeds/images/stanton/hurston/hur-l5/platinum.jpg').open,
  selling: true,
  hidden: hidden
)
