    ...
    module Public
      class HangarsController < ::Api::PublicBaseController
        ...
        def show
          ...
          vehicle_query_params["sorts"] = sorting_params(Vehicle, vehicle_query_params[:sorts], @user.hangar_sorting_params)
        ...
        def embed
          ...
          user_ids = User.where(normalized_username: usernames)
            .with_hangar_readable_by(current_resource_owner)
            .pluck(:id)
