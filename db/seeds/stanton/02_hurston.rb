...
hurston = Planet.find_or_initialize_by(name: 'Hurston')
hurston.update!(starsystem: stanton, store_image: Rails.root.join('db/seeds/images/hurston/hurston.png').open)

teasa_spaceport = Station.find_or_initialize_by(name: 'Teasa Spaceport')
teasa_spaceport.update!(planet: hurston, station_type: :spaceport, location: 'Lorville', store_image: Rails.root.join('db/seeds/images/hurston/teasa_spaceport.jpg').open)
...
l19.update!(planet: hurston, station_type: :district, location: 'Lorville', store_image: Rails.root.join('db/seeds/images/hurston/l19.jpg').open)
...
aberdeen = Planet.find_or_initialize_by(name: 'Aberdeen')
aberdeen.update!(planet: hurston)
arial = Planet.find_or_initialize_by(name: 'Arial')
arial.update!(planet: hurston)
ita = Planet.find_or_initialize_by(name: 'Ita')
ita.update!(planet: hurston)
magda = Planet.find_or_initialize_by(name: 'Magda')
magda.update!(planet: hurston)
