...
v1_admin_api_routes = lambda do
  ...
  resources :dock_capacities, only: %i[index show create update destroy], path: "dock-capacities"
  resources :dock_additions, only: %i[index show create destroy], path: "dock-additions"
