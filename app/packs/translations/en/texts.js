export default {
  ...
  support: {
    code:
      'Additionally you can get 5000 UEC starting money by using the following Recruitment Code <a href="https://robertsspaceindustries.com/enlist?referral=%{code}" target="_blank" rel="noopener"><b>"%{code}"</b></a> when you buy Star Citizen or you can:',
    info:
      'If you like FleetYards.net and want to support the further development and maintenance of this project please upvote our <a href="https://robertsspaceindustries.com/spectrum/community/SC/forum/57219/thread/fleetyards-net" target="_blank" rel="noopener"><b>Spectrum Post</b></a> and our Post on the <a href="https://robertsspaceindustries.com/community/deep-space-radar/1730-FleetYardsnet" target="_blank" rel="noopener"><b>Deep Space Radar</b></a>.',
  },
  error:
  ...
  compare: {
    models: {
      info:
        'To start select at least two and not more than eight Ships you want to compare.',
    },
  },
  fleets: {
  ...
  fleetPreview: {
    notified: {
      headline: 'Analyze',
      text:
        'View stats of your Fleet - analyze and optimize for roles, cargo capacity etc.',
    },
    overview: {
      headline: 'Overview & Manage',
      text:
        'Invite your Org Mates and get a filterable and searchable list of all public and purchased Ships. ',
    },
    fleetchart: {
      headline: 'Fleetchart',
      text:
        'View your Fleet as a scaled topview Fleetchart and export it as an image.',
    },
  },
  impressum: {
    visit: 'Visit',
