...
json.last_active_at user.last_active_at.utc.iso8601 if user.last_active_at.present?
json.confirmed_at user.confirmed_at.utc.iso8601 if user.confirmed_at.present?
